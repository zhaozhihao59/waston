package com.tocersoft.member.action.en.front;
...
@ParentPackage("front")
@Namespace("/en/register")
@Controller
public class RegisterEnAction extends BaseAction implements ModelDriven<MemberModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(RegisterEnAction.class);
	 ...
	 * @return 
	 */
	@Action(value = "to_apply_success", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/register/reg_apply_success.jsp") })
	 ...
	 * @return 
	 */
	@Action(value = "to_register", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/register/register_index.jsp") })
	...
	@Action(value = "index", results = { 
			@Result(name = "success", location = "/WEB-INF/pages/en/member/register/register_index.jsp"),
			@Result(name = "code_error", location = "/WEB-INF/pages/en/member/register/code_error.jsp")
	})
	public String index(){
		return SUCCESS;
	}
	 ...
	 * @return 
	 */
	@Action(value = "register", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/register/register_index.jsp") })
	 ...
	 * @return 
	 */
	@Action(value = "registerSuccess", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/register/register_success.jsp") })
	...
	@Action(value = "regist", 
		...
		results = { 
			@Result(name = "success", location = "/WEB-INF/pages/en/member/register/register_success.jsp"),
	 ...
	 * @return 
	 */
	@Action(value = "to_regist_success", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/register/register_success.jsp") })
