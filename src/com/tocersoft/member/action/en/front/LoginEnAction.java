...
@Namespace("/en/login")
@Controller
public class LoginEnAction extends BaseAction implements ModelDriven<MemberModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(LoginEnAction.class);
	...
	@Action(value = "index", results = { 
			@Result(name = "index", location = "/WEB-INF/pages/en/member/login/login_index.jsp")
		})
	public String index(){
...
/*	*//**
	...
	@Action(value = "login",
			...
			@Result(name="login",type="redirectAction",params={"namespace","/en","actionName","index"})
		})
	 ...
	 * @return 
	 */
	@Action(value = "forget", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/login/login_forget.jsp") })
...
//		}
	 ...
	 * @return 
	 */
	@Action(value = "forget_edit", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/login/login_forget_edit_password.jsp") })
	 ...
	 * @return 
	 */
	@Action(value = "forget_success", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/login/login_forget_edit_success.jsp") })
	...
	@Action(value = "logout",results = {
			@Result(name="success",type="redirectAction",params={"namespace","/en","actionName","index"})
	})
