...
@ParentPackage("front")
@Namespace("/en/member/address")
@Controller
public class MemberAddressEnAction extends BaseAction implements ModelDriven<MemAddressModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(MemberAddressEnAction.class);
	 ...
	 * @return 
	 */
	@Action(value = "address_list", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/account/address_list.jsp") })
	 ...
	 * @return 
	 */
	@Action(value = "addressEdit", results = { @Result(name = "success", location = "/WEB-INF/pages/en/member/account/add_address.jsp") })
...
*/			@Result(name="success",type="redirectAction",params={"namespace","/en/member/address","actionName","address_list"})
	...
	@Action(value="del",
			results = {
			@Result(name="success",type="redirectAction",params={"namespace","/en/member/address","actionName","address_list"}),
			@Result(name="error",type="redirectAction",params={"namespace","/en/member/address","actionName","address_list"})
			 }
	)
