...
@ParentPackage("admin")
@Namespace("/admin/mem_team")
@Controller
public class MemTeamAdminAction extends BaseAction implements ModelDriven<MemTeamModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(MemTeamAdminAction.class);
