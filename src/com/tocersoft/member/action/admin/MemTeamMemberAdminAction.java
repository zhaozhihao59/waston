...
@ParentPackage("admin")
@Namespace("/admin/memTeamMember")
@Controller
public class MemTeamMemberAdminAction extends BaseAction implements ModelDriven<MemTeamMemberModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(MemTeamMemberAdminAction.class);
