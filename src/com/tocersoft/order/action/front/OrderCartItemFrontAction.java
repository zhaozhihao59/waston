package com.tocersoft.order.action.front;
...
@Namespace("/cart")
@Controller
public class OrderCartItemFrontAction extends BaseAction implements ModelDriven<OrderCartItemModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(OrderCartItemFrontAction.class);
	...
	@Action(value = "index", results = { @Result(name = "success", location = "/WEB-INF/pages/front/order/cart_list.jsp") })
	public String index(){
