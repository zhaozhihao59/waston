package com.tocersoft.activity.action.front;
...
@ParentPackage("front")
@Namespace("/front/activity")
@Controller
public class ActivityFrontAction extends BaseAction implements ModelDriven<ActivityModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(ActivityFrontAction.class);
	 ...
	 * 活动详情
	 */
	@Action(value = "activities_detail", results = { @Result(name = "index", location = "/WEB-INF/pages/front/activities/activities_detail.jsp") })
	 ...
	 * 活动列表 历届 抽取页面
	 */
	@Action(value = "ListPageByOld", results = { @Result(name = "index", location = "/WEB-INF/pages/front/activities/activities_index_inc.jsp") })
