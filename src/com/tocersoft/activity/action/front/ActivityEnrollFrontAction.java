...
@ParentPackage("front")
@Namespace("/front/activityEnroll")
@Controller
public class ActivityEnrollFrontAction extends BaseAction implements ModelDriven<ActivityEnrollModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(ActivityEnrollFrontAction.class);
