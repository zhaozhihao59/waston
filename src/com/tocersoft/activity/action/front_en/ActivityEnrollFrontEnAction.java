 ...
 */
@ParentPackage("front")
@Namespace("/front/activityEnroll_en")
@Controller
public class ActivityEnrollFrontEnAction extends BaseAction implements ModelDriven<ActivityEnrollModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(ActivityEnrollFrontEnAction.class);
