package com.tocersoft.activity.action.front_en;
 ...
 */
@ParentPackage("front")
@Namespace("/front/activity_en")
@Controller
public class ActivityFrontEnAction extends BaseAction implements ModelDriven<ActivityModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(ActivityFrontEnAction.class);
	 ...
	 * 活动详情
	 */
	@Action(value = "activities_detail_en", results = { @Result(name = "index", location = "/WEB-INF/pages/front_en/activities/activities_detail.jsp") })
	 ...
	 * 活动列表 历届 抽取页面
	 */
	@Action(value = "ListPageByOld_en", results = { @Result(name = "index", location = "/WEB-INF/pages/front_en/activities/activities_index_inc.jsp") })
	 ...
	 * 活动详情
	 */
	@Action(value = "activitiesDetail_en", results = { @Result(name = "index", location = "/WEB-INF/pages/front_en/activities/activities_detail.jsp") })
