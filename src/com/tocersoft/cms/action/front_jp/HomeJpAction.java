...
@Controller
@Scope("prototype")
public class HomeJpAction extends BaseAction implements ModelDriven<IndexModel>{
	 ...
	 * 系统前台首页
	 */
	@Action(value = "index", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/index.jsp") })
	public String index() {
		//查询跑马灯广告
		List<CmsArticle> cmsarticletopfive = articleService.getAdvByTopFive(null,"jp");
		...
		//华诚动态，显示三条语句
		List<CmsArticle> getArticleByComplex1 = articleService.getArticleByComplex("3d5ffe8b-e890-11e4-ae9b-00266c0e7760",3,null,"jp");
		...
		List<CmsArticle> getArticleByComplex2 = articleService.getArticleByComplex2("b343df2e-ee3e-11e4-a8bb-0071cc954734",6,null,"jp");
	...
	/*	List<CmsArticle> getArticleByComplex3 = articleService.getArticleByComplexs("bba13349-e891-11e4-ae9b-00266c0e7760", "c25f9c04-e891-11e4-ae9b-00266c0e7760",5);*/
		List<CmsArticle> getArticleByComplex3  = articleService.getArticleListByChannelId("3b4e3fb0-e891-11e4-ae9b-00266c0e7760",6,null,"jp");
...
//		model.setCmsChannels(cmsChannels);
	 ...
	 */
	@Action(value = "search_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/search_result.jsp") })
...
//		}
	...
	@Action(value = "search_inc_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/search_result_inc.jsp") })
	...
	*/
	 ...
	 * 文章列表
	 */
	@Action(value = "cms_ListPage_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/cms_index.jsp") })
	 ...
	 * 文章列表
	 */
	@Action(value = "cms_ListPage_inc_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/cms_index_inc.jsp") })
	 ...
	 * 文章详情
	 */
	@Action(value = "cmsDetail_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/cms_detail.jsp") })
	 ...
	 * 出版物列表
	 */
	@Action(value = "pub_ListPage_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/pub_index.jsp") })
	public String pubListPage() {
		...
		model.getPageResult().setPageSize(5);
		model.getPageResult().setCurrentPage(model.getPage());
		articleService.getArticleListByPageByParentIdJp(model.getPageResult());
		// 著作
	 ...
	 * 出版物列表
	 */
	@Action(value = "pub_ListPage_page_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/pub_index_inc.jsp") })
	...
	@Action(value = "pub_ListPage_page_inc2_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/pub_index_inc2.jsp") })
	 ...
	 * 出版物详情
	 */
	@Action(value = "pubDetail_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/pub_detail.jsp") })
	 ...
	 * 专业人员
	 */
	@Action(value = "toProfessional_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/professional/professional.jsp") })
	 ...
	 * @throws UnsupportedEncodingException 
	 */
	@Action(value = "toProfessional_inc_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/professional/professional_inc.jsp") })
...
//			cc.setQualification(qualification);
	...
	@Action(value = "pub_ListPage_inc_jp")
	public String pub_ListPage_inc_jp() {
		// 查询期刊  查询期刊下的pdf文档
		List<CmsArticle> cmsArticleList = articleService.listArticleByCidJp(model.getItem().getChannelId());
		JSONArray array =new JSONArray();
		for (CmsArticle cmsarticle : cmsArticleList) {
			JSONObject json = new JSONObject();
			json.put("id",cmsarticle.getId());
			json.put("name",cmsarticle.getJpAnnexFilename());
			json.put("path",cmsarticle.getJpAnnexPath());
			array.add(json);
		}
