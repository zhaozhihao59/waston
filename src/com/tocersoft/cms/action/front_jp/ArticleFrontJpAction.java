...
@Controller
@Scope("prototype")
public class ArticleFrontJpAction extends BaseAction implements ModelDriven<CmsArticleModel> {
	 ...
	 * 
	 */
	@Action(value = "cmsDetail_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/cms/cms_detail.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "video_list_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/video_list.jsp") })
	...
	@Action(value = "game_result_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/cms/cms_index.jsp") })
	...
	@Action(value = "about_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/cms/front_jp/cms_about_index.jsp") })
	public String about() {
	...
	@Action(value = "news_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/cms/front_jp/cms_news_index.jsp") })
	public String news() {
	...
	@Action(value = "news_list_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/cms/front_jp/cms_news_list.jsp") })
	...
	@Action(value = "news_detail_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/cms/front_jp/cms_news_detail.jsp") })
	...
	@Action(value = "service_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/cms/front_jp/cms_service_index.jsp") })
	...
	@Action(value = "service_detail_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/cms/front_jp/cms_service_detail.jsp") })
	 ...
	 * 
	 */
	@Action(value = "aritlDetail_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/cms/cms_detail.jsp") })
...
//		getRequest().setAttribute("artile", artile);
	...
	@Action(value = "detail_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/cms/cms_detail.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "site_map", results = { @Result(name = "index_jp", location = "/WEB-INF/pages/front_jp/cms/site_map.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "search", results = { @Result(name = "index_jp", location = "/WEB-INF/pages/front_jp/cms/cms_list_search.jsp") })
...
//		String key = Utils.stringFormat(keyGet);
	 ...
	 * @return
	 */
	@Action(value = "contact", results = { @Result(name = "index_jp", location = "/WEB-INF/pages/front_jp/cms/cms_contact.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "culture", results = { @Result(name = "index_jp", location = "/WEB-INF/pages/front_jp/cms/cms_culture.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "toJobOpprtunity_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/work/job_opportunity.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "to_common_problem_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/common_problem.jsp") })
	public String to_common_problem() {
		CmsArticleCondition cmsarticleCondition = new CmsArticleCondition();
		cmsarticleCondition.setJp("jp");
	 ...
	 * 常见问题列表 抽取页面
	 */
	@Action(value = "ListPageByOld_jp", results = { @Result(name = "index", location = "/WEB-INF/pages/front_jp/common_problem_inc.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "business_field_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/work/knowledge_index.jsp") })
	public String business_field() {
		model.getI();
		// 公司商务业务
		List<CmsArticle> cmsArticleField1 = cmsArticleService.getArticleAllJp("c1272bc2-ee3e-11e4-a8bb-0071cc954734");
		model.setCmsArticleField1(cmsArticleField1);
		// 知识产权
		List<CmsArticle> cmsArticleField2 = cmsArticleService.getArticleAllJp("c884a615-ee3e-11e4-a8bb-0071cc954734");
		model.setCmsArticleField2(cmsArticleField2);
		// 诉讼仲裁业务
		List<CmsArticle> cmsArticleField3 = cmsArticleService.getArticleAllJp("d25b2a55-ee3e-11e4-a8bb-0071cc954734");
		model.setCmsArticleField3(cmsArticleField3);
		// 财富管理
		List<CmsArticle> cmsArticleField4 = cmsArticleService.getArticleAllJp("d987e778-ee3e-11e4-a8bb-0071cc954734");
