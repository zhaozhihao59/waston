...
@Controller
@Scope("prototype")
public class ArticleFrontEnAction extends BaseAction implements ModelDriven<CmsArticleModel> {
	 ...
	 * @return
	 */
	@Action(value = "video_list_en", results = { @Result(name = "index", location = "/WEB-INF/pages/front_en/cms/video_list.jsp") })
...
//		String key = Utils.stringFormat(keyGet);
	 ...
	 * @return
	 */
	@Action(value = "toJobOpprtunity_en", results = { @Result(name = "success", location = "/WEB-INF/pages/front_en/work/job_opportunity.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "to_common_problem_en", results = { @Result(name = "index", location = "/WEB-INF/pages/front_en/common_problem.jsp") })
	 ...
	 * 常见问题列表 抽取页面
	 */
	@Action(value = "ListPageByOld_en", results = { @Result(name = "index", location = "/WEB-INF/pages/front_en/common_problem_inc.jsp") })
	 ...
	 * @return
	 */
	@Action(value = "business_field_en", results = { @Result(name = "success", location = "/WEB-INF/pages/front_en/work/knowledge_index.jsp") })
	public String business_field() {
		try {
		model.getI();
		// 公司商务业务
		List<CmsArticle> cmsArticleField1 = cmsArticleService.getArticleAllEn("c1272bc2-ee3e-11e4-a8bb-0071cc954734");
		model.setCmsArticleField1(cmsArticleField1);
		// 知识产权
		List<CmsArticle> cmsArticleField2 = cmsArticleService.getArticleAllEn("c884a615-ee3e-11e4-a8bb-0071cc954734");
		model.setCmsArticleField2(cmsArticleField2);
		// 诉讼仲裁业务
		List<CmsArticle> cmsArticleField3 = cmsArticleService.getArticleAllEn("d25b2a55-ee3e-11e4-a8bb-0071cc954734");
		model.setCmsArticleField3(cmsArticleField3);
		// 财富管理
		List<CmsArticle> cmsArticleField4 = cmsArticleService.getArticleAllEn("d987e778-ee3e-11e4-a8bb-0071cc954734");
