package com.tocersoft.subscribe.action.front_jp;
...
@ParentPackage("front")
@Namespace("/front/subscribe_jp")
@Controller
public class SubscribeFrontJpAction extends BaseAction implements ModelDriven<SubscribeModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(SubscribeFrontJpAction.class);
