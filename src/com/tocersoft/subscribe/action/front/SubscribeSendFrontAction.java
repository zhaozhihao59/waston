...
@ParentPackage("front")
@Namespace("/front/subscribeSend")
@Controller
public class SubscribeSendFrontAction extends BaseAction implements ModelDriven<SubscribeSendModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(SubscribeSendFrontAction.class);
