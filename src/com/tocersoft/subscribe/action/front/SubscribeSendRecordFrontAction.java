...
@ParentPackage("front")
@Namespace("/front/subscribeSendRecord")
@Controller
public class SubscribeSendRecordFrontAction extends BaseAction implements ModelDriven<SubscribeSendRecordModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(SubscribeSendRecordFrontAction.class);
