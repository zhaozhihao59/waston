package com.tocersoft.product.action.front;
...
//	private ICartItemService cartItemService;
	...
	@Action(value = "index", results = { @Result(name = "success", location = "/WEB-INF/pages/front/zh/product/index.jsp") })
	public String index(){
		
		return SUCCESS;
	}
	
	@Action(value = "list", results = { @Result(name = "success", location = "/WEB-INF/pages/front/product/list.jsp") })
	public String list() throws UnsupportedEncodingException{
			...
			if(StringUtils.isNotBlank(categoryId)){
				...
				// 查询明星产品
				model.setCategoryAndBrandName("明星产品");
	...
	@Action(value = "detail", results = { @Result(name = "success", location = "/WEB-INF/pages/front/product/detail.jsp") })
