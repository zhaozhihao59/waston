...
@Namespace("/work_jp")
@Controller
public class workFrontJpAction extends BaseAction implements ModelDriven<CmsArticleModel>{

	private static final long serialVersionUID = 1L;

	private Log logger = LogFactory.getLog(workFrontJpAction.class);
	 ...
	 * @return 
	 */
	@Action(value = "knowledge_list_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/work/knowledge_index.jsp") })
	public String knowledge_list(){
		return SUCCESS;
	}
	@Action(value = "job_opportunity_jp", results = { @Result(name = "success", location = "/WEB-INF/pages_jp/front/work/job_opportunity.jsp") })
	public String job_opportunity(){
		return SUCCESS;
	}
	@Action(value = "about_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/work/about.jsp") })
	public String about(){
		return SUCCESS;
	}
	
	@Action(value = "property_agency_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/work/property_agency_jp.jsp") })
	...
	@Action(value = "contact_us_jp", results = { @Result(name = "success", location = "/WEB-INF/pages/front_jp/work/contact_us.jsp") })
