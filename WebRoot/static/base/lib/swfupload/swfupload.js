...
SWFUpload.prototype.initSWFUpload = function (settings) {
	try {
		...
		delete SWFUpload.instances[this.movieName+"heh"];
		throw ex;
	}
};
...
SWFUpload.prototype.initSettings = function () {
	...
	var bp = document.getElementsByTagName("base")[0].getAttribute("href");
	// Upload backend settings
	this.ensureDefault("upload_url", bp + "upload.htm?m="+Math.random());
	...
	this.ensureDefault("file_size_limit", 512);	// Default zero means "unlimited"
	this.ensureDefault("file_upload_limit", 0);
	this.ensureDefault("file_queue_limit", 1);

	// Flash Settings
	this.ensureDefault("flash_url",  basePath + "/static/base/lib/swfupload/swfupload.swf");
	this.ensureDefault("prevent_swf_caching", true);
	
	// Button Settings
	this.ensureDefault("button_image_url", bp + "/static/images/XPButtonUploadText_61x22_01.png");
	...
	this.ensureDefault("swfupload_loaded_handler", swfUploadLoaded);
	this.ensureDefault("file_dialog_start_handler", fileDialogStart);
