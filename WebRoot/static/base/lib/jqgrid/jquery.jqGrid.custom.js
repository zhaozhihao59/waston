...
(function($) {
	$.jgrid = {
		defaults : {
			recordtext : "第{0} - {1}条，共 {2} 条记录", // 共字前是全角空格
			emptyrecords : "无数据显示",
			loadtext : "数据加载中，请稍候...",
			pgtext : " {0} 共 {1} 页"
		},
...
(function(b) {
	...
	b.extend(b.jgrid, {
		htmlDecode : function(e) {
			if (e
					&& (e == "&nbsp;" || e == "&#160;" || e.length === 1
							&& e.charCodeAt(0) === 160))
				return "";
			return !e ? e : String(e).replace(/&gt;/g, ">").replace(/&lt;/g,
					"<").replace(/&quot;/g, '"').replace(/&amp;/g, "&")
		},
		...
		format : function(e) {
			...
			if (e === undefined)
				e = "";
			return e.replace(/\{(\d+)\}/g, function(g, c) {
						return i[c]
					})
		},
		getCellIndex : function(e) {
			...
			if (e.is("tr"))
				return -1;
			e = (!e.is("td") && !e.is("th") ? e.closest("td,th") : e)[0];
			if (b.browser.msie)
				return b.inArray(e, e.parentNode.cells);
			return e.cellIndex
		},
		...
		stripPref : function(e, i) {
			var g = Object.prototype.toString.call(e).slice(8, -1);
			if (g == "String" || g == "Number") {
				e = String(e);
				i = e !== "" ? String(i).replace(String(e), "") : i
			}
			return i
		},
		stringToDoc : function(e) {
			var i;
			if (typeof e !== "string")
				return e;
			try {
			...
			return i && i.documentElement
					&& i.documentElement.tagName != "parsererror" ? i : null
		},
		parse : function(e) {
			if (e.substr(0, 9) == "while(1);")
				e = e.substr(9);
			if (e.substr(0, 2) == "/*")
		...
		parseDate : function(e, i) {
			...
			if (i && i !== null && i !== undefined) {
				...
				for (h = e.length; c < h; c++) {
					...
					if (i[c] !== undefined)
						g[e[c].toLowerCase()] = parseInt(i[c], 10)
				}
		...
		uidPref : "jqg",
		randId : function(e) {
			return (e ? e : b.jgrid.uidPref) + b.jgrid.guid++
		},
		getAccessor : function(e, i) {
			var g, c, h = [], k;
		...
		getXmlData : function(e, i, g) {
			var c = typeof i === "string" ? i.match(/^(.*)\[(\w+)\]$/) : null;
			if (typeof i === "function")
				return i(e);
			if (c && c[2])
				return c[1] ? b(c[1], e).attr(c[2]) : b(e).attr(c[2]);
			else {
				e = b(i, e);
				if (g)
					return e;
				return e.length > 0 ? b(e).text() : undefined
			}
		},
		ajaxOptions : {},
		from : function(e) {
			return new function(i, g) {
				...
				if (typeof i == "object" && i.push) {
					if (i.length > 0)
						V = typeof i[0] != "object" ? false : true
				} else
				...
				this._toStr = function(o) {
					if (l)
						o = b.trim(o);
					k || (o = o.toLowerCase());
					return o = o.toString().replace(/\\/g, "\\\\").replace(
							/\"/g, '\\"')
				};
				...
				this._getGroup = function(o, n, t, F, T) {
					...
					b.each(c._getOrder(o, n, t, F, T), function(fa, pa) {
				...
				this._compareValues = function(o, n, t, F, T) {
					var J;
					J = V
							? "jQuery.jgrid.getAccessor(this,'" + n + "')"
							: "this";
					if (t === undefined)
						t = null;
					var D = t, ca = T.stype === undefined ? "text" : T.stype;
					if (t !== null)
						switch (ca) {
							case "int" :
							case "integer" :
							...
							case "datetime" :
								D = String(b.jgrid.parseDate(
										T.newfmt || "Y-m-d", D).getTime());
								J = 'jQuery.jgrid.parseDate("' + T.srcfmt
										+ '",' + J + ").getTime()";
								break;
							default :
								J = c._getStr(J);
				...
				this.startsWith = function(o, n) {
					...
					if (V)
						c._append(c._getStr("jQuery.jgrid.getAccessor(this,'"
								+ o + "')")
								+ ".substr(0,"
								+ t
								+ ") == "
						...
						t = l
								? b.trim(n.toString()).length
								: n.toString().length;
						c._append(c._getStr("this") + ".substr(0," + t
				...
				this.endsWith = function(o, n) {
					var t = n === undefined || n === null ? o : n;
					t = l ? b.trim(t.toString()).length : t.toString().length;
					V ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'"
							+ o + "')")
							+ ".substr("
							+ c._getStr("jQuery.jgrid.getAccessor(this,'" + o
									+ "')")
							+ ".length-"
							+ t
							+ ","
							+ t
							+ ') == "' + c._toStr(n) + '"') : c._append(c
							._getStr("this")
							+ ".substr("
							+ c._getStr("this")
							+ '.length-"'
				...
				this.contains = function(o, n) {
					V ? c._append(c._getStr("jQuery.jgrid.getAccessor(this,'"
							+ o + "')")
							+ '.indexOf("' + c._toStr(n) + '",0) > -1') : c
							._append(c._getStr("this") + '.indexOf("'
									+ c._toStr(o) + '",0) > -1');
				...
				this.orderBy = function(o, n, t, F) {
					n = n === undefined || n === null ? "a" : b.trim(n
	...
	b.fn.jqGrid = function(e) {
		if (typeof e == "string") {
			var i = b.jgrid.getAccessor(b.fn.jqGrid, e);
			if (!i)
		...
		return this.each(function() {
			if (!this.grid) {
				var c = b.extend(true, {
							...
							cmTemplate : {},
							idPrefix : ""
						}, b.jgrid.defaults, e || {}), h = {
					headers : [],
					cols : [],
					footers : [],
					dragStart : function(d, f, j) {
						this.resizing = {
							idx : d,
							startX : f.clientX,
							sOL : j[0]
						...
						this.curGbox = b("#rs_m" + b.jgrid.jqID(c.id), "#gbox_"
										+ b.jgrid.jqID(c.id));
						this.curGbox.css({
									display : "block",
									left : j[0],
					...
					dragMove : function(d) {
						if (this.resizing) {
							var f = d.clientX - this.resizing.startX;
							d = this.headers[this.resizing.idx];
							var j = c.direction === "ltr"
									? d.width + f
									: d.width - f, m;
							if (j > 33) {
								this.curGbox.css({
					...
					dragEnd : function() {
						...
						if (this.resizing) {
							var d = this.resizing.idx, f = this.headers[d].newWidth
									|| this.headers[d].width;
							f = parseInt(f, 10);
							this.resizing = false;
							b("#rs_m" + b.jgrid.jqID(c.id)).css("display",
									"none");
							...
							if (this.footers.length > 0)
								this.footers[d].style.width = f + "px";
							if (c.forceFit === true) {
								f = this.headers[d + c.nv].newWidth
										|| this.headers[d + c.nv].width;
								this.headers[d + c.nv].width = f;
								this.headers[d + c.nv].el.style.width = f
										+ "px";
								this.cols[d + c.nv].style.width = f + "px";
								if (this.footers.length > 0)
									this.footers[d + c.nv].style.width = f
											+ "px";
								c.colModel[d + c.nv].width = f
							} else {
					...
					populateVisible : function() {
						...
						if (d) {
							...
							if (m) {
								...
								var s = Math.round(f.position().top) - j, A = s
										+ f.height();
								m *= C;
								var z, u, w;
								if (A < d
					...
					selectionPreserver : function(d) {
						var f = d.p, j = f.selrow, m = f.selarrrow ? b
								.makeArray(f.selarrrow) : null, p = d.grid.bDiv.scrollLeft, C = f.gridComplete;
				...
				if (this.tagName.toUpperCase() != "TABLE")
					...
					if (this.p.colNames.length !== this.p.colModel.length)
						...
						var q = b("<div class='ui-jqgrid-view'></div>"), x, y = b.browser.msie
								? true
						...
						var M = function(d, f) {
							d = parseInt(d, 10);
							return isNaN(d) ? f ? f : 0 : d
						}, N = function(d, f, j, m, p, C) {
							var s = a.p.colModel[d], A = s.align, z = 'style="', u = s.classes, w = s.name, r = [];
							if (A)
								z += "text-align:" + A + ";";
							if (s.hidden === true)
								z += "display:none;";
							if (f === 0)
								z += "width: " + h.headers[d].width + "px;";
							else if (s.cellattr && b.isFunction(s.cellattr))
								if ((d = s.cellattr.call(a, p, j, m, s, C))
										&& typeof d === "string") {
							...
							if (typeof C.formatter !== "undefined") {
								...
								f = b.isFunction(C.formatter) ? C.formatter
										.call(a, f, d, m, p) : b.fmatter
										? b.fn.fmatter(C.formatter, f, d, m, p)
										: V(f)
							} else
								f = V(f);
							return f
						}, n = function(d, f, j, m, p) {
							f = o(d, f, j, p, "add");
							...
							for (p = 0; p < a.p.colModel.length; p++) {
								f = a.p.colModel[p];
								if (f.name !== "cb" && f.name !== "subgrid"
										&& f.name !== "rn") {
									j[m] = d == "local" ? f.name : d == "xml"
											|| d === "xmlstring" ? f.xmlmap
											|| f.name : f.jsonmap || f.name;
									m++
								}
							}
							return j
							...
							if (a.p.deepempty)
								...
								b("#" + b.jgrid.jqID(a.p.id) + " tbody:first")
										.empty().append(m)
							}
							if (f && a.p.scroll) {
								b(">div:first", d).css({
							...
							var d = a.p.data.length, f, j, m;
							f = a.p.rownumbers === true ? 1 : 0;
							j = a.p.multiselect === true ? 1 : 0;
							m = a.p.subGrid === true ? 1 : 0;
							f = a.p.keyIndex === false || a.p.loadonce === true
									? a.p.localReader.id
									: a.p.colModel[a.p.keyIndex + j + m + f].name;
							for (j = 0; j < d; j++) {
								m = b.jgrid.getAccessor(a.p.data[j], f);
								a.p._index[m] = j
							}
						}, X = function(d, f, j, m, p) {
							var C = new Date, s = a.p.datatype != "local"
									&& a.p.loadonce
									|| a.p.datatype == "xmlstring", A = a.p.xmlReader, z = a.p.datatype == "local"
									? "local"
									: "xml";
							if (s) {
								a.p.data = [];
							...
							if (b.isXMLDoc(d)) {
								...
								z = (L + "").indexOf("[") === -1 ? Z.length
										...
										: function(ga, ba) {
											return b(A.cell, ga).eq(L).text()
													|| ba
										} : function(ga, ba) {
									return ga.getAttribute(L.replace(/[\[\]]/g,
											""))
											|| ba
								};
								a.p.userData = {};
								a.p.page = b.jgrid.getXmlData(d, A.page) || 0;
								a.p.lastpage = b.jgrid.getXmlData(d, A.total);
								if (a.p.lastpage === undefined)
									a.p.lastpage = 1;
								a.p.records = b.jgrid.getXmlData(d, A.records)
										|| 0;
								if (b.isFunction(A.userdata))
									a.p.userData = A.userdata.call(a, d) || {};
								else
									b.jgrid.getXmlData(d, A.userdata, true)
											.each(function() {
												a.p.userData[this
														.getAttribute("name")] = b(this)
														.text()
											});
								d = b.jgrid.getXmlData(d, A.root, true);
								(d = b.jgrid.getXmlData(d, A.row, true))
										|| (d = []);
								var $ = d.length, W = 0, ha = {}, ja = parseInt(
										a.p.rowNum, 10);
								if ($ > 0 && a.p.page <= 0)
									a.p.page = 1;
								if (d && $) {
								...
								if (s) {
									a.p.records = $;
									a.p.lastpage = Math.min(a.p.page, Math
													.ceil($ / ja))
								}
							...
							if (d) {
								...
								var z = 0, u, w, r = [], G, O = 0, S = 0, K = 0, L, Z, P = {}, v, B, H = [], U = a.p.altRows === true
										? " " + a.p.altclass
										: "";
								a.p.page = b.jgrid.getAccessor(d, f.page) || 0;
								L = b.jgrid.getAccessor(d, f.total);
								a.p.lastpage = L === undefined ? 1 : L;
								a.p.records = b.jgrid.getAccessor(d, f.records)
										|| 0;
								a.p.userData = b.jgrid.getAccessor(d,
										f.userdata)
										|| {};
								f.repeatitems || (G = r = T(s));
								s = a.p.keyIndex === false
										? f.id
										: a.p.keyIndex;
								...
								(Z = b.jgrid.getAccessor(d, f.root))
										|| (Z = []);
								L = Z.length;
								d = 0;
								if (L > 0 && a.p.page <= 0)
									a.p.page = 1;
								var ia = parseInt(a.p.rowNum, 10), $ = a.p.scroll
										? b.jgrid.randId()
										: 1;
								if (p)
									ia *= p + 1;
								var W = b.isFunction(a.p.afterInsertRow), ha = {}, ja = "";
								if (a.p.grouping
										&& a.p.groupingView.groupCollapse === true)
								...
								for (; d < L;) {
									...
									H
											.push("<tr"
													...
													+ '">');
									if (a.p.rownumbers === true) {
										H.push(F(0, d, a.p.page, a.p.rowNum));
										K = 1
									}
									if (a.p.multiselect) {
										H.push(t(B, K, d));
									...
									if (f.repeatitems) {
										if (f.cell)
											p = b.jgrid.getAccessor(p, f.cell);
										G || (G = J(O + S + K))
									}
									for (w = 0; w < G.length; w++) {
										u = b.jgrid.getAccessor(p, G[w]);
										H
												.push(n(B, u, w + O + S + K, d
																+ j, p));
									...
									if (a.p.grouping) {
										...
										ha = b(a).jqGrid("groupingPrepare", H,
												w, ha, P);
										H = []
									}
							...
							if (b.isArray(a.p.data)) {
								...
								if (a.p.treeGrid)
									b(a).jqGrid("SortTree", f, a.p.sortorder,
											m[f].stype, m[f].srcfmt);
								else {
									var w = {
										eq : function(v) {
											return v.equals
									...
									if (a.p.grouping) {
										r.orderBy(C, u.groupOrder[0],
												p[0].stype, p[0].srcfmt);
							...
							if (!a.grid.hDiv.loading) {
								var f = a.p.scroll && d === false, j = {}, m, p = a.p.prmNames;
								if (a.p.page <= 0)
									a.p.page = 1;
								if (p.search !== null)
								...
								var C = a.p.loadComplete, s = b.isFunction(C);
								s || (C = null);
								var A = 0;
								d = d || 1;
								if (d > 1)
						...
						x = function(d, f) {
							...
							if (a.p.rowList.length > 0) {
								...
								for (s = 0; s < a.p.rowList.length; s++)
									p += '<option role="option" value="'
											+ a.p.rowList[s]
											+ '"'
											+ (a.p.rowNum == a.p.rowList[s]
													? ' selected="selected"'
													: "") + ">"
											+ a.p.rowList[s] + "</option>";
								p += "</select></td>"
							}
							if (l == "rtl")
								m += p;
							...
							if (a.p.pgbuttons === true) {
								...
								b("#first" + b.jgrid.jqID(f) + ", #prev"
										+ b.jgrid.jqID(f) + ", #next"
										+ b.jgrid.jqID(f) + ", #last"
										+ b.jgrid.jqID(f)).click(function() {
									var w = M(a.p.page, 1), r = M(a.p.lastpage,
						...
						var Ea = function(d, f, j, m) {
							if (a.p.colModel[f].sortable)
								if (!(a.p.savedRow.length > 0)) {
									...
									b("span.ui-icon-" + a.p.sortorder, m)
									...
									d = d.substring(5 + a.p.id.length + 1);
									a.p.sortname = a.p.colModel[f].index || d;
									j = a.p.sortorder;
									if (b.isFunction(a.p.onSortCol))
										if (a.p.onSortCol.call(a, d, f, j) == "stop") {
											a.p.lastsort = f;
											return
										}
									if (a.p.datatype == "local")
		...
		(function		() {
							var d = 0, f = E ? 0 : a.p.cellLayout, j = 0, m, p = a.p.scrollOffset, C, s = false, A, z = 0, u = 0, w;
							b.each(a.p.colModel, function() {
							...
							if (a.p.shrinkToFit === true && j > 0) {
								...
								w = 0;
								if (s) {
									if (h.width - z - (d + f * j) !== p)
										w = h.width - z - (d + f * j) - p
								} else if (!s
										&& Math.abs(h.width - z - (d + f * j)) !== 1)
									w = h.width - z - (d + f * j);
								a.p.colModel[m].width += w;
								a.p.tblwidth = d + w + f * j + z;
						...
						b("th", q).each(function(d) {
							ta = a.p.colModel[d].width;
							...
							ua = a.p.colModel[d].sortable;
							if (typeof ua !== "boolean")
								ua = a.p.colModel[d].sortable = true;
							f = a.p.colModel[d].name;
							f == "cb"
									|| f == "subgrid"
									|| f == "rn"
									|| a.p.viewsortcols[2]
						...
						xa = null;
						q = b("<table class='ui-jqgrid-htable' style='width:"
								+ a.p.tblwidth
								+ "px' role='grid' aria-labelledby='gbox_"
								+ this.id
								+ "' cellspacing='0' cellpadding='0' border='0'></table>")
								.append(da);
						var ea = a.p.caption && a.p.hiddengrid === true
								? true
								: false;
						...
						a.p.cellEdit === false && a.p.hoverrows === true
								&& b(a).bind("mouseover", function(d) {
									Q = b(d.target).closest("tr.jqgrow");
						...
						var la, ma;
						b(a).before(h.hDiv).click(function(d) {
							Y = d.target;
							...
							if (b.isFunction(a.p.beforeSelectRow))
								j = a.p.beforeSelectRow.call(a, Q[0].id, d);
							if (Y.tagName == "A"
									|| (Y.tagName == "INPUT"
											|| Y.tagName == "TEXTAREA"
							...
							if (j === true) {
								if (a.p.cellEdit === true)
									if (a.p.multiselect && f)
										b(a).jqGrid("setSelection", Q[0].id,
												true);
									else {
										la = Q[0].rowIndex;
										ma = b.jgrid.getCellIndex(Y);
										try {
											b(a).jqGrid("editCell", la, ma,
													true)
										} catch (m) {
										}
									}
								...
								if (b.isFunction(a.p.onCellSelect)) {
									la = Q[0].id;
									ma = b.jgrid.getCellIndex(Y);
									a.p.onCellSelect.call(a, la, ma, b(Y)
													.html(), d)
								}
							}
							return this
						}).bind("reloadGrid", function(d, f) {
							if (a.p.treeGrid === true)
						...
						b.isFunction(this.p.ondblClickRow)
								&& b(this).dblclick(function(d) {
									...
									la = Q[0].rowIndex;
									ma = b.jgrid.getCellIndex(Y);
									a.p.ondblClickRow.call(a, b(Q).attr("id"),
											la, ma, d);
									return false
								});
						...
						if (y)
							if (String(a.p.height).toLowerCase() === "auto")
								a.p.height = "100%";
						b(h.bDiv).append(b('<div style="position:relative;'
								+ (y && b.browser.version < 8
										? "height:0.01%;"
										: "") + '"></div>')
						...
						if (y) {
							...
							a.p.multikey
									&& b(h.bDiv).bind("mousedown", function() {
												return false
											});
						ea && b(h.bDiv).hide();
						h.cDiv = document.createElement("div");
						var Ba = a.p.hidegrid === true
						...
						if (a.p.caption) {
							...
							if (a.p.hidegrid === true) {
								b(".ui-jqgrid-titlebar-close", h.cDiv).click(
										function(d) {
											var f = b
							...
							b(h.cDiv).hide();
						b(h.hDiv).after(h.bDiv).mousemove(function(d) {
									if (h.resizing) {
										h.dragMove(d);
										return false
									}
						...
						a.formatCol = N;
						a.sortData = Ea;
						a.updatepager = function(d, f) {
							var j, m, p, C, s, A, z, u = "", w = a.p.pager
							...
							if (u) {
								...
								j = M(a.p.page);
								m = M(a.p.lastpage);
								b(".selbox", u)[this.p.useProp
										? "prop"
										: "attr"]("disabled", false);
								if (a.p.pginput === true) {
									b(".ui-pg-input", u).val(a.p.page);
									C = a.p.toppager ? "#sp_1" + w + ",#sp_1"
											+ r : "#sp_1" + w;
									b(C).html(b.fmatter
									...
									if (a.p.reccount === 0)
										...
										if (b.fmatter) {
											C = b.fmatter.util.NumberFormat(C,
													z);
											s = b.fmatter.util.NumberFormat(s,
													z);
											A = b.fmatter.util.NumberFormat(A,
													z)
										}
										b(".ui-paging-info", u)
												.html(b.jgrid
						...
						a.formatter = function(d, f, j, m, p) {
							return o(d, f, j, m, p)
						};
						b.extend(h, {
									populate : ka,
	...
	b.jgrid.extend({
		getGridParam : function(e) {
			var i = this[0];
			if (i && i.grid)
				return e ? typeof i.p[e] != "undefined" ? i.p[e] : null : i.p
		},
						...
						if (c.p.multiselect) {
							...
							if (l === -1) {
								k.className !== "ui-subgrid"
										&& b(k).addClass("ui-state-highlight")
							...
							b("#jqg_" + b.jgrid.jqID(c.p.id) + "_"
									+ b.jgrid.jqID(c.p.selrow))[c.p.useProp
									? "prop"
									: "attr"]("checked", h);
							if (q) {
								l === -1 ? b("#" + b.jgrid.jqID(e),
										"#" + b.jgrid.jqID(q))
								...
								b(		"#jqg_" + b.jgrid.jqID(c.p.id) + "_"
												+ b.jgrid.jqID(e), "#"
												+ b.jgrid.jqID(q))[c.p.useProp
										? "prop"
										: "attr"]("checked", h)
							}
							c.p.onSelectRow && i
									&& c.p.onSelectRow.call(c, k.id, h)
		...
		resetSelection : function(e) {
			return this.each(function() {
						...
						if (typeof e !== "undefined") {
							c = e === i.p.selrow ? i.p.selrow : e;
							b("#" + b.jgrid.jqID(i.p.id) + " tbody:first tr#"
									+ b.jgrid.jqID(c))
									.removeClass("ui-state-highlight").attr(
											"aria-selected", "false");
							if (i.p.multiselect) {
								b("#jqg_" + b.jgrid.jqID(i.p.id) + "_"
										+ b.jgrid.jqID(c))[i.p.useProp
										? "prop"
										: "attr"]("checked", false);
							...
							b(i.p.selarrrow).each(function(h, k) {
								...
								b(g).removeClass("ui-state-highlight").attr(
										"aria-selected", "false");
								b("#jqg_" + b.jgrid.jqID(i.p.id) + "_"
										+ b.jgrid.jqID(k))[i.p.useProp
										? "prop"
										: "attr"]("checked", false)
							});
							i.setHeadCheckBox(false);
						...
						if (i.p.cellEdit === true)
							if (parseInt(i.p.iCol, 10) >= 0
								...
								b("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow])
		...
		delRowData : function(e) {
			...
			this.each(function() {
						if (g = this.rows.namedItem(e)) {
							...
							i = true;
							if (this.p.multiselect) {
								c = b.inArray(e, this.p.selarrrow);
						...
						if (this.p.altRows === true && i) {
							...
							b(this.rows).each(function(l) {
								l % 2 == 1 ? b(this).addClass(k) : b(this)
										.removeClass(k)
							})
						}
					});
								...
								b(this.p.colModel).each(function(N) {
									...
									if (i[c] !== undefined) {
										y[c] = this.formatter
												&& typeof this.formatter === "string"
												&& this.formatter == "date"
												? b.unformat.date(i[c], this)
												: i[c];
										a = l.formatter(e, i[c], N, i, "edit");
										k = this.title ? {
								...
								if (l.p.datatype == "local") {
									...
									if (l.p.treeGrid)
										for (var I in l.p.treeReader)
											y.hasOwnProperty(l.p.treeReader[I])
			...
			if (i) {
				...
				this.each(function() {
					...
					for (var T = 0, J = "", D = {}, ca = b
							.isFunction(this.p.afterInsertRow) ? true : false; T < F;) {
						n = i[T];
						l = "";
						if (N) {
							try {
							...
							J = this.p.altRows === true
									? (this.rows.length - 1) % 2 === 0 ? o : ""
									: ""
						}
						e = this.p.idPrefix + e;
						if (x) {
							M = this.formatCol(0, 1, "", null, e, true);
						...
						if (a) {
							I = '<input role="checkbox" type="checkbox" id="jqg_'
									+ this.p.id + "_" + e + '" class="cbox"/>';
							M = this.formatCol(x, 1, "", null, e, true);
							l += '<td role="gridcell" aria-describedby="'
									+ this.p.id + '_cb" ' + M + ">" + I
									+ "</td>"
						}
						if (q)
							l += b(this).jqGrid("addSubGridCell", a + x, 1);
						for (E = a + q + x; E < this.p.colModel.length; E++) {
							t = this.p.colModel[E];
							k = t.name;
							D[k] = t.formatter
									&& typeof t.formatter === "string"
									&& t.formatter == "date" ? b.unformat.date(
									n[k], t) : n[k];
							I = this.formatter(e, b.jgrid.getAccessor(n, k), E,
									n, "edit");
							M = this.formatCol(E, 1, I, n, e, true);
							l += '<td role="gridcell" aria-describedby="'
									+ this.p.id + "_" + k + '" ' + M + ">" + I
									+ "</td>"
						}
						l = '<tr id="'
								...
								+ this.p.direction + " " + J + '">' + l
								+ "</tr>";
						if (this.rows.length === 0)
							b("table:first", this.grid.bDiv).append(l);
						else
							switch (g) {
								case "last" :
						...
						this.p.subGrid === true
								&& b(this).jqGrid("addSubGrid", a + x, y);
						this.p.records++;
						this.p.reccount++;
						ca && this.p.afterInsertRow.call(this, e, n, n);
						T++;
						if (this.p.datatype == "local") {
							D[this.p.localReader.id] = e;
							this.p._index[e] = this.p.data.length;
							this.p.data.push(D);
							D = {}
						}
					}
					if (this.p.altRows === true && !N)
						if (g == "last")
							...
							b(this.rows).each(function(fa) {
								fa % 2 == 1 ? b(this).addClass(o) : b(this)
										.removeClass(o)
							});
		...
		showHideCol : function(e, i) {
			return this.each(function() {
				var g = this, c = false, h = b.browser.webkit
						|| b.browser.safari ? 0 : g.p.cellLayout, k;
				if (g.grid) {
					if (typeof e === "string")
						e = [e];
					i = i != "none" ? "" : "none";
					...
					b(this.p.colModel).each(function(q) {
						if (b.inArray(this.name, e) !== -1 && this.hidden === l) {
							...
							g.p.footerrow
									&& b("tr.footrow td:eq(" + q + ")",
											g.grid.sDiv).css("display", i);
							k = this.widthOrg ? this.widthOrg : parseInt(
									this.width, 10);
							if (i === "none")
								g.p.tblwidth -= k + h;
							else
		...
		remapColumns : function(e, i, g) {
			...
			i
					&& h(b("#" + b.jgrid.jqID(k.p.id) + " tbody:first"),
			...
			if (k.p.remapColumns)
				if (k.p.remapColumns.length)
					...
					k.p.remapColumns = b.makeArray(e);
			k.p.lastsort = b.inArray(k.p.lastsort, e);
			if (k.p.treeGrid)
				k.p.expColInd = b.inArray(k.p.expColInd, e)
		},
		setGridWidth : function(e, i) {
			return this.each(function() {
				if (this.grid) {
					var g = this, c, h = 0, k = b.browser.webkit
							|| b.browser.safari ? 0 : g.p.cellLayout, l, a = 0, q = false, x = g.p.scrollOffset, y, E = 0, I = 0, M;
					if (typeof i != "boolean")
						i = g.p.shrinkToFit;
					if (!isNaN(e)) {
						e = parseInt(e, 10);
						g.grid.width = g.p.width = e;
						b("#gbox_" + b.jgrid.jqID(g.p.id)).css("width",
								e + "px");
						b("#gview_" + b.jgrid.jqID(g.p.id)).css("width",
								e + "px");
						b(g.grid.bDiv).css("width", e + "px");
						b(g.grid.hDiv).css("width", e + "px");
						g.p.pager && b(g.p.pager).css("width", e + "px");
						g.p.toppager && b(g.p.toppager).css("width", e + "px");
						if (g.p.toolbar[0] === true) {
							b(g.grid.uDiv).css("width", e + "px");
							g.p.toolbar[1] == "both"
									&& b(g.grid.ubDiv).css("width", e + "px")
						}
						g.p.footerrow && b(g.grid.sDiv).css("width", e + "px");
						if (i === false && g.p.forceFit === true)
							g.p.forceFit = false;
						if (i === true) {
							...
							if (q) {
								if (e - E - (h + k * a) !== x)
									M = e - E - (h + k * a) - x
							} else if (Math.abs(e - E - (h + k * a)) !== 1)
								M = e - E - (h + k * a);
							g.p.colModel[l].width += M;
							g.p.tblwidth = h + M + k * a + E;
							if (g.p.tblwidth > e) {
								q = g.p.tblwidth - parseInt(e, 10);
								g.p.tblwidth = e;
							...
							if (N)
								g.grid.cols[l].style.width = c + "px";
							if (g.p.footerrow)
								g.grid.footers[l].style.width = c + "px"
						}
						if (g.p.tblwidth) {
							b("table:first", g.grid.bDiv).css("width",
									g.p.tblwidth + "px");
							b("table:first", g.grid.hDiv).css("width",
									g.p.tblwidth + "px");
							g.grid.hDiv.scrollLeft = g.grid.bDiv.scrollLeft;
							g.p.footerrow
									&& b("table:first", g.grid.sDiv).css(
		...
		setCaption : function(e) {
			return this.each(function() {
						...
						b("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",
								this.grid.cDiv).html(e);
						b(this.grid.cDiv).show()
					})
		},
		setLabel : function(e, i, g, c) {
			return this.each(function() {
						var h = -1;
						if (this.grid)
							if (typeof e != "undefined") {
			...
			return this.each(function() {
						...
						if (this.grid) {
							if (isNaN(i))
								...
								l = parseInt(i, 10);
							if (l >= 0)
								if (a = this.rows.namedItem(e)) {
									var x = b("td:eq(" + l + ")", a);
									if (g !== "" || k === true) {
										a = this.formatter(e, g, l, a, "edit");
										q = this.p.colModel[l].title ? {
											title : b.jgrid.stripHtml(a)
										} : {};
										this.p.treeGrid
												&& b(".tree-wrap", b(x)).length > 0
												? b("span", b(x)).html(a)
														.attr(q)
												: b(x).html(a).attr(q);
										if (this.p.datatype == "local") {
		...
		bindKeys : function(e) {
			...
			return this.each(function() {
				...
				b(g).keydown(function(c) {
					var h = b(g).find("tr[tabindex=0]")[0], k, l, a, q = g.p.treeReader.expanded_field;
					if (h) {
						a = g.p._index[h.id];
						if (c.keyCode === 37 || c.keyCode === 38
								|| c.keyCode === 39 || c.keyCode === 40) {
							if (c.keyCode === 38) {
								l = h.previousSibling;
								k = "";
								if (l)
							...
							if (c.keyCode === 37) {
								g.p.treeGrid
										&& g.p.data[a][q]
										&& b(h).find("div.treeclick")
												.trigger("click");
								b.isFunction(i.onLeftKey)
										&& i.onLeftKey.call(g, g.p.selrow)
							}
							if (c.keyCode === 39) {
								g.p.treeGrid
										&& !g.p.data[a][q]
										&& b(h).find("div.treeclick")
												.trigger("click");
								b.isFunction(i.onRightKey)
										&& i.onRightKey.call(g, g.p.selrow)
							}
						} else if (c.keyCode === 13)
							b.isFunction(i.onEnter)
									&& i.onEnter.call(g, g.p.selrow);
						else
							c.keyCode === 32 && b.isFunction(i.onSpace)
									&& i.onSpace.call(g, g.p.selrow)
					}
				})
			})
		},
...
(function(b) {
	...
	b.extend(b.fmatter, {
				...
				isObject : function(a) {
					return a && (typeof a === "object" || b.isFunction(a))
							|| false
				},
				isString : function(a) {
				...
				isEmpty : function(a) {
					if (!this.isString(a) && this.isValue(a))
						...
						return true;
					a = b.trim(a).replace(/\&nbsp\;/ig, "").replace(
							/\&#160\;/ig, "");
					return a === ""
				}
			});
	...
	b.fmatter.util = {
		NumberFormat : function(a, c) {
			...
			if (b.fmatter.isNumber(a)) {
				var d = a < 0, e = a + "", f = c.decimalSeparator
						? c.decimalSeparator
						: ".", g;
		...
		DateFormat : function(a, c, d, e) {
			var f = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, g = typeof c === "string"
					? c.match(f)
					: null;
			f = function(m, r) {
				m = String(m);
			...
			var l = i.getSeconds(), n = i.getMilliseconds(), o = i.getDay(), p = i
				...
				I : "?",
				O : (j > 0 ? "-" : "+")
						+ f(	Math.floor(Math.abs(j) / 60) * 100
										+ Math.abs(j) % 60, 4),
				P : "?",
				T : (String(i)
	...
	b.fn.fmatter.defaultFormat = function(a, c) {
		return b.fmatter.isValue(a) && a !== "" ? a : c.defaultValue
				? c.defaultValue
				: "&#160;"
	};
	b.fn.fmatter.email = function(a, c) {
		return b.fmatter.isEmpty(a)
				? b.fn.fmatter.defaultFormat(a, c)
				: '<a href="mailto:' + a + '">' + a + "</a>"
	};
	...
	b.fn.fmatter.select = function(a, c) {
		...
		if (b.fmatter.isUndefined(c.colModel.formatoptions)) {
			if (!b.fmatter.isUndefined(c.colModel.editoptions)) {
				...
				f = c.colModel.editoptions.separator === undefined
						? ":"
						: c.colModel.editoptions.separator
			}
		} else {
			d = c.colModel.formatoptions.value;
			f = c.colModel.formatoptions.separator === undefined
					? ":"
					: c.colModel.formatoptions.separator
		}
		if (d) {
			var g = c.colModel.editoptions.multiple === true ? true : false, h = [], i;
			if (g) {
				h = a.split(",");
	...
	b.fn.fmatter.rowactions = function(a, c, d, e) {
		...
		var g = function(j) {
			f.afterRestore && f.afterRestore(j);
			b(
					"tr#" + a + " div.ui-inline-edit, tr#" + a
							+ " div.ui-inline-del",
					"#" + c + ".ui-jqgrid-btable:first").show();
			...
			case "edit" :
				...
				b(
						"tr#" + a + " div.ui-inline-save, tr#" + a
								+ " div.ui-inline-cancel",
						"#" + c + ".ui-jqgrid-btable:first").show();
				b.isFunction(h.p._complete) && h.p._complete.call(h);
				break;
			case "save" :
	...
	a.jgrid.extend({
			...
			return this.each(function() {
				if (this.grid)
					if (b == "hidden") {
						...
						this.p.footerrow
								&& a(".ui-jqgrid-sdiv", "#gbox_" + this.p.id)
										.slideUp("fast");
						...
						a(".ui-jqgrid-hdiv, .ui-jqgrid-bdiv",
								"#gview_" + this.p.id).slideDown("fast");
		...
		filterToolbar : function(b) {
			...
			return this.each(function() {
				function e(d, g) {
					var h = a(d);
					h[0] && jQuery.each(g, function() {
								this.data !== undefined ? h.bind(this.type,
										this.data, this.fn) : h.bind(this.type,
										this.fn)
							})
				}
				var c = this;
				if (!this.ftoolbar) {
					var j = function() {
						...
						if (b.stringResult === true || c.p.datatype == "local") {
							var l = '{"groupOp":"' + b.groupOp + '","rules":[', t = 0;
							...
							a.each(
									["searchField", "searchString",
											"searchOper"], function(r, v) {
										c.p.postData.hasOwnProperty(v)
						...
						if (this.search)
							switch (this.stype) {
								...
								case "text" :
									...
									f.dataInit !== undefined
											&& f.dataInit(a("input", g)[0]);
									f.dataEvents !== undefined
											&& e(a("input", g)[0], f.dataEvents);
									if (b.autosearch === true)
										b.searchOnEnter ? a("input", g)
												.keypress(function(o) {
													if ((o.charCode
															? o.charCode
															: o.keyCode
					...
					this.clearToolbar = function(d) {
						...
						if (b.stringResult === true || c.p.datatype == "local") {
							var n = '{"groupOp":"' + b.groupOp + '","rules":[', l = 0;
							...
							a.each(
									["searchField", "searchString",
											"searchOper"], function(q, r) {
										c.p.postData.hasOwnProperty(r)
					...
					this.toggleToolbar = function() {
						var d = a("tr.ui-search-toolbar", c.grid.hDiv), g = c.p.frozenColumns === true
		...
		setGroupHeaders : function(b) {
			...
			return this.each(function() {
				...
				for (c = 0; c < m; c++) {
					...
					a("<th>", {
								role : "gridcell"
							}).css(d).addClass("ui-first-th-" + e.p.direction)
							.appendTo(q);
					g.style.width = "";
				...
				if (b.useColSpanStyle) {
					l.find("span.ui-jqgrid-resize").each(function() {
						var s = a(this).parent();
						if (s.is(":visible"))
							this.style.cssText = "height: " + s.height()
									+ "px !important; cursor: col-resize;"
					});
					l.find("div.ui-jqgrid-sortable").each(function() {
						var s = a(this), u = s.parent();
						u.is(":visible")
								&& u.is(":has(span.ui-jqgrid-resize)")
								&& s.css("top", (u.height() - s.outerHeight())
												/ 2 + "px")
					})
				}
		...
		setFrozenColumns : function() {
			return this.each(function() {
				if (this.grid) {
					...
					if (!(b.p.subGrid == true || b.p.treeGrid === true
							|| b.p.cellEdit == true || b.p.sortable
						...
						if (k >= 0 && p) {
							...
							b.p.orgEvents = {};
							if (b.p.toppager)
								e += a(b.grid.topDiv).outerHeight();
							if (b.p.toolbar[0] == true)
								if (b.p.toolbar[1] != "bottom")
									e += a(b.grid.uDiv).outerHeight();
							...
							if (b.p.groupHeader) {
								...
								var d = -1, g = -1;
								a("tr.jqg-second-row-header th", e).each(
										function() {
											var h = parseInt(a(this)
															.attr("colspan"),
													10);
											if (h) {
												d += h;
							...
							b.p.resizeStop = function(h, f) {
								...
								if (a.isFunction(b.p.orgEvents.resizeStop))
									b.p.orgEvents.resizeStop.call(b, h, f);
								else
									b.p.orgEvents.resizeStop = null
							};
							b.p.orgEvents.onSortCol = a
									.isFunction(b.p.onSortCol)
									? b.p.onSortCol
									: null;
							b.p.onSortCol = function(h, f, i) {
								var m = a("tr.ui-jqgrid-labels:last th:eq("
												+ b.p.lastsort + ")",
										b.grid.fhDiv), n = a(
										"tr.ui-jqgrid-labels:last th:eq(" + f
												+ ")", b.grid.fhDiv);
								a("span.ui-grid-ico-sort", m)
										.addClass("ui-state-disabled");
								a(m).attr("aria-selected", "false");
								a("span.ui-icon-" + b.p.sortorder, n)
										.removeClass("ui-state-disabled");
								...
								a.isFunction(b.p.orgEvents.onSortCol)
										&& b.p.orgEvents.onSortCol.call(b, h,
												f, i)
							};
							a("#gview_" + a.jgrid.jqID(b.p.id))
									.append(b.grid.fbDiv);
							jQuery(b.grid.bDiv).scroll(function() {
								jQuery(b.grid.fbDiv).scrollTop(jQuery(this)
										.scrollTop())
							});
							b.p.orgEvents.complete = a
									.isFunction(b.p._complete)
									? b.p._complete
									: null;
							b.p.hoverrows === true
							...
							b.p._complete = function() {
								a("#" + a.jgrid.jqID(b.p.id) + "_frozen")
										.remove();
								jQuery(b.grid.fbDiv).height(jQuery(b.grid.bDiv)
										.height()
										- 16);
								var h = a("#" + a.jgrid.jqID(b.p.id))
										.clone(true);
								...
								if (b.p.hoverrows === true) {
									...
									a("tr.jqgrow", "#" + a.jgrid.jqID(b.p.id))
											.hover(function() {
												a(this)
														.addClass("ui-state-hover");
												a(
								...
								h = null;
								a.isFunction(b.p.orgEvents.complete)
										&& b.p.orgEvents.complete.call(b)
							};
...
(function(a) {
	a.extend(a.jgrid, {
		...
		createModal : function(b, c, d, f, g, h, j) {
			...
			i.id = b.modalhead;
			a(i).append("<span class='ui-jqdialog-title'>" + d.caption
					+ "</span>");
			var n = a("<a href='javascript:void(0)' class='ui-jqdialog-titlebar-close ui-corner-all'></a>")
					.hover(function() {
			...
			a(r).addClass("ui-jqdialog-content ui-widget-content").attr("id",
					b.modalcontent);
			a(r).append(c);
			e.appendChild(r);
			a(e).prepend(i);
			if (h === true)
				...
				typeof h == "string" ? a(h).append(e) : a(e).insertBefore(f);
			a(e).css(j);
			...
			a("a.ui-jqdialog-titlebar-close", i).click(function() {
				var o = a("#" + b.themodal).data("onClose") || d.onClose, s = a("#"
			...
			if (d.height === 0 || !d.height)
				d.height = 200;
			if (!d.zIndex) {
				f = a(f).parents("*[role=dialog]").filter(":first")
						.css("z-index");
		...
		createEl : function(b, c, d, f, g) {
			function h(m, l) {
				...
				l.dataEvents && a.each(l.dataEvents, function() {
							this.data !== undefined ? a(m).bind(this.type,
									this.data, this.fn) : a(m).bind(this.type,
									this.fn)
						});
				return l
			}
			function j(m, l, o) {
				var s = ["dataInit", "dataEvents", "dataUrl", "buildSelect",
					...
					if (typeof c.dataUrl != "undefined")
						a.ajax(a.extend({
							...
							success : function(m) {
								var l = [], o = this.elem, s = this.vl, p = a
										.extend({}, this.options), t = p.multiple === true;
						...
						if (typeof c.value === "string") {
							...
							for (k = 0; k < q.length; k++) {
								...
								e.appendChild(g);
								if (!b
										&& (a.trim(i[0]) == a.trim(d) || a
												.trim(i[1]) == a.trim(d)))
									g.selected = "selected";
								if (b
										&& (a.inArray(a.trim(i[1]), f) > -1 || a
												.inArray(a.trim(i[0]), f) > -1))
									g.selected = "selected"
							}
							...
							for (k in n)
								if (n.hasOwnProperty(k)) {
									...
									if (!b
										...
										g.selected = "selected";
									if (b
											&& (a.inArray(a.trim(n[k]), f) > -1 || a
													.inArray(a.trim(k), f) > -1))
										g.selected = "selected"
								}
						}
						j(e, c, ["value"]);
				...
				case "custom" :
					...
					try {
						if (a.isFunction(c.custom_element))
							if (n = c.custom_element.call(this, d, c)) {
						...
						r == "e1"
								&& this.info_dialog(a.jgrid.errors.errcap,
										...
										a.jgrid.edit.bClose);
						r == "e2" ? this.info_dialog(a.jgrid.errors.errcap,
								"function 'custom_element' "
										+ a.jgrid.edit.msg.novalue,
								a.jgrid.edit.bClose) : this.info_dialog(
								a.jgrid.errors.errcap, typeof r === "string"
										? r
										: r.message, a.jgrid.edit.bClose)
					}
			}
			return e
		},
		...
		checkValues : function(b, c, d, f, g) {
			...
			if (h) {
				...
				if (h.required === true)
					if (this.isEmpty(b))
						return [false, j + ": " + a.jgrid.edit.msg.required, ""];
				f = h.required === false ? false : true;
				if (h.number === true)
					if (!(f === false && this.isEmpty(b)))
						if (isNaN(b))
							return [false, j + ": " + a.jgrid.edit.msg.number,
									""];
				if (typeof h.minValue != "undefined" && !isNaN(h.minValue))
					if (parseFloat(b) < parseFloat(h.minValue))
						return [
								false,
								j + ": " + a.jgrid.edit.msg.minValue + " "
										+ h.minValue, ""];
				if (typeof h.maxValue != "undefined" && !isNaN(h.maxValue))
					if (parseFloat(b) > parseFloat(h.maxValue))
						return [
								false,
								j + ": " + a.jgrid.edit.msg.maxValue + " "
										+ h.maxValue, ""];
				if (h.email === true)
					if (!(f === false && this.isEmpty(b))) {
						...
						if (!g.test(b))
							return [false, j + ": " + a.jgrid.edit.msg.email,
									""]
					}
				if (h.integer === true)
					if (!(f === false && this.isEmpty(b))) {
						if (isNaN(b))
							return [false, j + ": " + a.jgrid.edit.msg.integer,
									""];
				...
				if (h.url === true)
					if (!(f === false && this.isEmpty(b))) {
						...
						if (!g.test(b))
							return [false, j + ": " + a.jgrid.edit.msg.url, ""]
					}
				if (h.custom === true)
					if (!(f === false && this.isEmpty(b)))
...
(function(a) {
	...
	a.jgrid.extend({
				...
				if (e.grid) {
					...
					if (a("#" + G.themodal).html() !== null)
						...
						var w = a("<div><div id='"
								...
								.insertBefore("#gview_" + e.p.id), n = "left", j = "";
						...
						if (f.columns.length)
							...
							a.each(s, function(u, C) {
								if (!C.label)
									C.label = e.p.colNames[u];
								if (!m) {
									var A = typeof C.search === "undefined"
											? true
						...
						f.gbox = "#gbox_" + q;
						f.layer ? a.jgrid.createModal(G, w, f, "#gview_"
										+ e.p.id, a("#gbox_" + e.p.id)[0], "#"
										+ f.layer, {
									position : "relative"
								}) : a.jgrid.createModal(G, w, f, "#gview_"
										+ e.p.id, a("#gbox_" + e.p.id)[0]);
						t && a("#" + q + "_query").bind("click", function() {
									a(".queryresult", w).toggle();
									return false
								});
						if (f.stringResult === undefined)
							f.stringResult = f.multipleSearch;
						a("#" + q + "_search").bind("click", function() {
							var u = a("#" + q), C = {}, A, l = u
									.jqFilter("filterData");
							if (f.errorcheck) {
								u[0].hideError();
							...
							if (a.isFunction(f.onSearch))
								f.onSearch();
							a(e).trigger("reloadGrid", [{
												page : 1
											}]);
							f.closeAfterSearch
									&& a.jgrid.hideModal("#" + G.themodal, {
												gb : "#gbox_" + e.p.id,
												jqm : f.jqModal,
												onClose : f.onClose
											});
						...
						b();
						a(".fm-button:not(.ui-state-disabled)", w).hover(
								function() {
									a(this).addClass("ui-state-hover")
								}, function() {
									a(this).removeClass("ui-state-hover")
		...
		editGridRow : function(f, b) {
			...
			return this.each(function() {
				function e() {
					a("#" + i + " > tbody > tr > td > .FormElement").each(
							function() {
				...
				function q(g, k, v, p) {
					...
					a(k.p.colModel).each(function(S) {
						...
						R = (D = this.editrules
								...
								: "";
						if (E !== "cb" && E !== "subgrid"
								&& this.editable === true && E !== "rn") {
							if (I === false)
								r = "";
							else if (E == k.p.ExpandColumn
									&& k.p.treeGrid === true)
								r = a("td:eq(" + S + ")", k.rows[I]).text();
							else {
								try {
									r = a.unformat(a("td:eq(" + S + ")",
													k.rows[I]), {
												rowId : g,
												colModel : this
											}, S)
							...
							var X = a.extend({}, this.editoptions || {}, {
										...
										rowabove : false,
										rowcontent : ""
									}, this.formoptions || {}), da = parseInt(
									Y.rowpos, 10)
									|| L + 1, fa = parseInt((parseInt(Y.colpos,
											10) || 1)
											* 2, 10);
							if (g == "_empty" && X.defaultValue)
								r = a.isFunction(X.defaultValue) ? X
										.defaultValue() : X.defaultValue;
							if (!this.edittype)
								this.edittype = "text";
							if (c.p.autoencode)
								r = a.jgrid.htmlDecode(r);
							F = a.jgrid.createEl(this.edittype, X, r, false,
									a.extend({}, a.jgrid.ajaxOptions,
											k.p.ajaxSelectOptions || {}));
							if (r === "" && this.edittype == "checkbox")
								r = a(F).attr("offval");
							if (r === "" && this.edittype == "select")
								r = a("option:eq(0)", F).text();
							...
							a("td:eq(" + (fa - 2) + ")", z[0])
									.html(typeof Y.label === "undefined"
											? k.p.colNames[S]
											: Y.label);
							a("td:eq(" + (fa - 1) + ")", z[0])
									.append(Y.elmprefix).append(F)
									.append(Y.elmsuffix);
							T[L] = S;
							L++
						}
				...
				function x(g, k, v) {
					...
					if (g == "_empty") {
						a(F).each(function() {
							...
							if ((z = a("#" + a.jgrid.jqID(p), "#" + v))
									&& z.length && z[0] !== null) {
								r = "";
								if (L.defaultValue) {
									r = a.isFunction(L.defaultValue) ? L
				...
				function G() {
					a.each(c.p.colModel, function(g, k) {
						if (k.editoptions && k.editoptions.NullIfEmpty === true)
							if (h.hasOwnProperty(k.name) && h[k.name] === "")
								h[k.name] = "null"
					})
				}
				function B() {
					...
					if (a.isFunction(d[c.p.id].beforeCheckValues)) {
						var R = d[c.p.id].beforeCheckValues(h, a("#" + o),
								h[c.p.id + "_id"] == "_empty"
										? p.addoper
										: p.editoper);
					...
					G();
					if (k[0]) {
						if (a.isFunction(d[c.p.id].onclickSubmit))
							v = d[c.p.id].onclickSubmit(d[c.p.id], h) || {};
						if (a.isFunction(d[c.p.id].beforeSubmit))
							k = d[c.p.id].beforeSubmit(h, a("#" + o))
					}
					if (k[0] && !d[c.p.id].processing) {
						...
						D = p.oper;
						E = p.id;
						h[D] = a.trim(h[c.p.id + "_id"]) == "_empty"
								? p.addoper
								: p.editoper;
						if (h[D] != p.addoper)
							h[E] = h[c.p.id + "_id"];
						...
						if (c.p.treeGrid === true) {
							if (h[D] == p.addoper) {
								...
								h[c.p.treeGridModel == "adjacency"
										? c.p.treeReader.parent_id_field
										: "parent_id"] = L
							}
							for (r in c.p.treeReader)
								if (c.p.treeReader.hasOwnProperty(r)) {
									v = c.p.treeReader[r];
						...
						r = a.extend({
							url : d[c.p.id].url ? d[c.p.id].url : a(c).jqGrid(
									"getGridParam", "editurl"),
							type : d[c.p.id].mtype,
							data : a.isFunction(d[c.p.id].serializeEditData)
									? d[c.p.id].serializeEditData(h)
									: h,
							complete : function(F, T) {
								...
								if (T != "success") {
									k[0] = false;
									k[1] = a
											.isFunction(d[c.p.id].errorTextFormat)
											? d[c.p.id].errorTextFormat(F)
											: T + " Status: '" + F.statusText
													+ "'. Error code: "
													+ F.status
								} else if (a.isFunction(d[c.p.id].afterSubmit))
									k = d[c.p.id].afterSubmit(F, h);
								if (k[0] === false) {
									...
									h = a.extend(h, O);
									c.p.autoencode && a.each(h, function(P, S) {
									...
									if (h[D] == p.addoper) {
										...
										if (d[c.p.id].closeAfterAdd) {
											if (d[c.p.id].reloadAfterSubmit)
												...
												a(c).jqGrid("addChildNode",
														k[2], L, h);
											else {
												a(c).jqGrid("addRowData", k[2],
														h, b.addedrow);
												a(c).jqGrid("setSelection",
														k[2])
											}
											...
											c.p.treeGrid === true ? a(c)
													.jqGrid("addChildNode",
															k[2], L, h) : a(c)
													.jqGrid("addRowData", k[2],
															h, b.addedrow)
									} else {
										if (d[c.p.id].reloadAfterSubmit) {
											a(c).trigger("reloadGrid");
									...
									if (d[c.p.id].checkOnSubmit
										...
										if (d[c.p.id]._savedData[c.p.id + "_id"] != "_empty")
				...
				function j() {
					if (f !== "_empty" && typeof c.p.savedRow !== "undefined"
				...
				function s(g, k) {
					g === 0 ? a("#pData", "#" + i + "_2")
							...
							"#" + i + "_2").removeClass("ui-state-disabled");
					g == k ? a("#nData", "#" + i + "_2")
							.addClass("ui-state-disabled") : a("#nData",
							"#" + i + "_2").removeClass("ui-state-disabled")
				}
				function M() {
					var g = a(c).jqGrid("getDataIDs"), k = a("#id_g", "#" + i)
							.val();
					return [a.inArray(k, g), g]
				}
				var c = this;
				if (c.grid && f) {
					var t = c.p.id, o = "FrmGrid_" + t, i = "TblGrid_" + t, m = {
						themodal : "editmod" + t,
						modalhead : "edithd" + t,
						modalcontent : "editcnt" + t,
						scrollelm : o
					}, H = a.isFunction(d[c.p.id].beforeShowForm)
							? d[c.p.id].beforeShowForm
							: false, J = a.isFunction(d[c.p.id].afterShowForm)
							? d[c.p.id].afterShowForm
							: false, u = a.isFunction(d[c.p.id].beforeInitData)
							? d[c.p.id].beforeInitData
							: false, C = a
							.isFunction(d[c.p.id].onInitializeForm)
					...
					if (a("#" + m.themodal).html() !== null) {
						...
						if (A === false)
							return;
						j();
						a(".ui-jqdialog-title", "#" + m.modalhead)
								.html(b.caption);
						a("#FormError", "#" + i).hide();
						if (d[c.p.id].topinfo) {
						...
						if (d[c.p.id].bottominfo) {
							...
							a(".binfo", "#" + i + "_2").hide();
						x(f, c, o);
						f == "_empty" || !d[c.p.id].viewPagerButtons ? a(
								"#pData, #nData", "#" + i + "_2").hide() : a(
								"#pData, #nData", "#" + i + "_2").show();
						...
						u[0].rp = 0;
						a(V).append(u);
						A = (u = c.p.direction == "rtl" ? true : false)
								? "nData"
								: "pData";
						var W = u ? "pData" : "nData";
						q(f, c, V, l);
						...
						A += "<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"
								+ d[c.p.id].bottominfo + "</td></tr>";
						A += "</tbody></table>";
						if (y > 0) {
							var aa = [];
							a.each(a(V)[0].rows, function(g, k) {
										aa[g] = k
									});
						...
						a.jgrid.createModal(m, K, b, "#gview_" + c.p.id,
								a("#gbox_" + c.p.id)[0]);
						if (u) {
							a("#pData, #nData", "#" + i + "_2").css("float",
									"right");
						...
						if (b.checkOnUpdate) {
							a("a.ui-jqdialog-titlebar-close span",
									"#" + m.themodal).removeClass("jqmClose");
							a("a.ui-jqdialog-titlebar-close", "#" + m.themodal)
		...
		viewGridRow : function(f, b) {
			...
			return this.each(function() {
				...
				function q(l, y, h, O) {
					...
					a(y.p.colModel).each(function() {
						U = this.editrules
								...
								? false
								: this.hidden === true ? true : false;
						if (!U && this.align === "right")
							if (this.formatter
									&& a.inArray(this.formatter, g) !== -1)
								k = Math.max(k, parseInt(this.width, 10));
							else
					...
					a(y.p.colModel).each(function(L) {
						...
						W = (U = this.editrules
								...
								? "style='display:none'"
								: "";
						D = typeof this.viewable != "boolean"
								? true
								: this.viewable;
						if (N !== "cb" && N !== "subgrid" && N !== "rn" && D) {
							V = Z === false ? "" : N == y.p.ExpandColumn
									&& y.p.treeGrid === true ? a(
									"td:eq(" + L + ")", y.rows[Z]).text() : a(
									"td:eq(" + L + ")", y.rows[Z]).html();
							E = this.align === "right" && p !== 0
									? true
									: false;
							...
							var r = a.extend({}, {
										rowabove : false,
										rowcontent : ""
									}, this.formoptions || {}), R = parseInt(
									r.rowpos, 10)
									|| K + 1, F = parseInt((parseInt(r.colpos,
											10) || 1)
											* 2, 10);
							if (r.rowabove) {
							...
							a("td:eq(" + (F - 2) + ")", Q[0]).html("<b>"
									+ (typeof r.label === "undefined"
											? y.p.colNames[L]
											: r.label) + "</b>");
							a("td:eq(" + (F - 1) + ")", Q[0]).append("<span>"
									+ V + "</span>").attr("id", "v_" + N);
					...
					if (Q = a(y).jqGrid("getInd", l, true)) {
						a("td", Q).each(function(K) {
							...
							O = y.p.colModel[K].editrules
									...
									? false
									: y.p.colModel[K].hidden === true
											? true
											: false;
							if (h !== "cb" && h !== "subgrid" && h !== "rn") {
								U = h == y.p.ExpandColumn
										&& y.p.treeGrid === true ? a(this)
										.text() : a(this).html();
								a.extend({}, y.p.colModel[K].editoptions || {});
								h = a.jgrid.jqID("v_" + h);
								a("#" + h + " span", "#" + s).html(U);
								O
										&& a("#" + h, "#" + s)
				...
				function B() {
					var l = a(w).jqGrid("getDataIDs"), y = a("#id_g", "#" + s)
							.val();
					return [a.inArray(y, l), l]
				}
				var w = this;
				if (w.grid && f) {
					var n = w.p.id, j = "ViewGrid_" + n, s = "ViewTbl_" + n, M = {
						themodal : "viewmod" + n,
						modalhead : "viewhd" + n,
						modalcontent : "viewcnt" + n,
						scrollelm : j
					}, c = a.isFunction(b.beforeInitData)
							? b.beforeInitData
					...
					if (a("#" + M.themodal).html() !== null) {
						...
						if (i > 0) {
							var C = [];
							a.each(a(H)[0].rows, function(l, y) {
										C[l] = y
									});
							C.sort(function(l, y) {
										if (l.rp > y.rp)
						...
						m = a("<span></span>")
								...
								.append("<table border='0' class='EditTable' id='"
										...
										+ u
										+ "</td></tr></tbody></table>");
						a.jgrid.createModal(M, m, b, "#gview_" + w.p.id,
								a("#gview_" + w.p.id)[0]);
						if (c) {
							a("#pData, #nData", "#" + s + "_2").css("float",
									"right");
							a(".EditButton", "#" + s + "_2").css("text-align",
									"left")
						}
						b.viewPagerButtons
						...
						a(".fm-button:not(.ui-state-disabled)", "#" + s + "_2")
								.hover(function() {
											a(this).addClass("ui-state-hover")
										}, function() {
											a(this)
		...
		delGridRow : function(f, b) {
			...
			return this.each(function() {
				...
				if (e.grid)
					if (f) {
						var q = a.isFunction(d[e.p.id].beforeShowForm), x = a
								.isFunction(d[e.p.id].afterShowForm), G = a
								.isFunction(d[e.p.id].beforeInitData)
								? d[e.p.id].beforeInitData
						...
						if (a("#" + o.themodal).html() !== null) {
							...
							var i = isNaN(d[e.p.id].dataheight)
									? d[e.p.id].dataheight
									: d[e.p.id].dataheight + "px";
							i = "<div id='"
									+ j
							...
							i += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='"
									...
									+ "</td></tr></tbody></table>";
							b.gbox = "#gbox_" + B;
							a.jgrid.createModal(o, i, b, "#gview_" + e.p.id,
									a("#gview_" + e.p.id)[0]);
							if (G) {
								n = G(a("#" + j));
								if (typeof n == "undefined")
							...
							a("#dData", "#" + j + "_2").click(function() {
								...
								if (a.isFunction(d[e.p.id].onclickSubmit))
									w = d[e.p.id].onclickSubmit(d[e.p.id], H)
											|| {};
								if (a.isFunction(d[e.p.id].beforeSubmit))
									m = d[e.p.id].beforeSubmit(H);
								if (m[0] && !d[e.p.id].processing) {
									d[e.p.id].processing = true;
									a(this).addClass("ui-state-active");
									c = e.p.prmNames;
									s = a.extend({}, d[e.p.id].delData, w);
									t = c.oper;
									s[t] = c.deloper;
									M = c.id;
									H = H.split(",");
									...
									J = a.extend(
											{
												...
												type : d[e.p.id].mtype,
												data : a
														.isFunction(d[e.p.id].serializeDelData)
														? d[e.p.id]
																.serializeDelData(s)
														: s,
												complete : function(u, C) {
													if (C != "success") {
														m[0] = false;
														m[1] = a
																.isFunction(d[e.p.id].errorTextFormat)
																? d[e.p.id]
																		.errorTextFormat(u)
																: C
																		+ " Status: '"
									...
									if (!J.url && !d[e.p.id].useDataProxy)
					...
					if (!(!n.grid || typeof f != "string")) {
						if (a("#" + w.themodal).html() === null) {
							if (!b.alerttop && !b.alertleft) {
								...
								b.alertleft = b.alertleft / 2
										- parseInt(b.alertwidth, 10) / 2;
						...
						for (var M = 0; M < s; M++) {
							...
							if (b.edit) {
								...
								a(j, c).attr({
									...
									if (!a(this).hasClass("ui-state-disabled")) {
										var i = n.p.selrow;
										if (i)
											a.isFunction(b.editfunc) ? b
													.editfunc(i) : a(n).jqGrid(
													"editGridRow", i, e);
										else {
							...
							if (b.view) {
								...
								a(j, c).attr({
									...
									if (!a(this).hasClass("ui-state-disabled")) {
										var i = n.p.selrow;
										if (i)
											a.isFunction(b.viewfunc) ? b
													.viewfunc(i) : a(n).jqGrid(
													"viewGridRow", i, B);
										else {
											a.jgrid.viewModal("#" + w.themodal,
													{
							...
							if (b.search) {
								...
								G.showOnLoad && G.showOnLoad === true
										&& a(j, c).click();
								j = null
							}
							if (b.refresh) {
				...
				if (this.grid) {
					...
					if (e)
						if (!(b.id && a("#" + b.id, e).html() !== null)) {
							...
							if (b.position == "first")
								e.rows[0].cells.length === 0 ? a("tr", e)
										.append(x) : a("tr td:eq(0)", e)
										.before(x);
							else
								a("tr", e).append(x);
							a(x, e).attr("title", b.title || "").click(
									function(G) {
										a(this).hasClass("ui-state-disabled")
												|| a
														.isFunction(b.onClickButton)
												&& b.onClickButton.call(q, G);
										return false
									}).hover(function() {
								a(this).hasClass("ui-state-disabled")
										|| a(this).addClass("ui-state-hover")
			...
			if (!this.filter) {
				...
				if (x) {
					...
					this.createTableForGroup = function(d, g) {
						...
						if (this.p.ruleButtons === true) {
							...
							for (b = 0; b < o.groupOps.length; b++) {
								l = d.groupOp === a.p.groupOps[b].op
										? " selected='selected'"
										: "";
								f += "<option value='" + a.p.groupOps[b].op
										+ "'" + l + ">" + a.p.groupOps[b].text
										+ "</option>"
							}
						...
						if (this.p.ruleButtons === true) {
							...
							f.bind("click", function() {
								...
								for (b = 0; b < a.p.columns.length; b++) {
									var n = typeof a.p.columns[b].search === "undefined"
											? true
								...
								d.rules.push({
											field : m.name,
											op : (m.searchoptions.sopt
													? m.searchoptions.sopt
													: a.p.sopt
															? a.p.sopt
															: m.searchtype === "string"
																	? a.p.stropts
						...
						if (d.groups !== undefined)
							for (b = 0; b < d.groups.length; b++) {
								...
								i.append(f);
								f = c("<td colspan='4'></td>");
								f.append(this.createTableForGroup(d.groups[b],
										d));
								i.append(f)
							}
						...
						if (d.rules !== undefined)
							for (b = 0; b < d.rules.length; b++)
								e.append(this.createTableRowForRule(d.rules[b],
										d));
						return e
					};
					this.createTableRowForRule = function(d, g) {
						...
						s.bind("change", function() {
							...
							if (h) {
								...
								var r = c.jgrid.createEl(h.inputtype,
										h.searchoptions, "", true,
										a.p.ajaxSelectOptions, true);
								c(r).addClass("input-elm");
								i = h.searchoptions.sopt
										? h.searchoptions.sopt
										: a.p.sopt
												? a.p.sopt
												: h.searchtype === "string"
														? a.p.stropts
								...
								if (c.browser.msie && c.browser.version < 9) {
									u = parseInt(c("select.selectopts", f)[0].offsetWidth)
											+ 1;
									c(".selectopts", f).width(u);
									c(".selectopts", f).css("width", "auto")
								}
								c(".data", f).empty().append(r);
								c(".input-elm", f).bind("change", function() {
											d.data = c(this).val();
											a.onchange()
										});
								setTimeout(function() {
						...
						for (e = n = 0; e < a.p.columns.length; e++) {
							m = typeof a.p.columns[e].search === "undefined"
									? true
							...
							if (a.p.columns[e].searchoptions.searchhidden === true
								...
								l += "<option value='" + a.p.columns[e].name
						...
						if (y && h.inputtype === "text")
							if (!h.searchoptions.size)
								h.searchoptions.size = 10;
						n = c.jgrid.createEl(h.inputtype, h.searchoptions,
								d.data, true, a.p.ajaxSelectOptions, true);
						...
						for (e = 0; e < i.length; e++) {
							p = c.inArray(i[e], t);
							if (p !== -1) {
								m = d.op === a.p.ops[p].name
										? " selected='selected'"
										: "";
								l += "<option value='" + a.p.ops[p].name + "'"
										+ m + ">" + a.p.ops[p].description
										+ "</option>"
							}
						}
						v.append(l);
						...
						b.append(l);
						l.append(n);
						c(n).addClass("input-elm").bind("change", function() {
									d.data = c(this).val();
									a.onchange()
								});
						l = c("<td></td>");
					...
					this.getStringForRule = function(d) {
						...
						return c.inArray(e.searchtype, ["int", "integer",
										"float", "number", "currency"]) !== -1
								|| a === "nn" || a === "nu" ? d.field + " " + g
								+ " " + b : d.field + " " + g + ' "' + b + '"'
					};
					this.resetFilter = function() {
						this.p.filter = c.extend(true, {}, this.p.initFilter);
						this.reDraw();
						this.onchange()
					};
...
(function(a) {
	...
	a.jgrid.extend({
		editRow : function(c, d, b, i, q, l, s, m, t) {
			var h = {
				keys : d || false,
				oneditfunc : b || null,
				successfunc : i || null,
				url : q || null,
				extraparam : l || {},
				aftersavefunc : s || null,
				errorfunc : m || null,
				afterrestorefunc : t || null,
				restoreAfterError : true,
				mtype : "POST"
			}, u = a.makeArray(arguments).slice(1), e;
			e = u[0] && typeof u[0] == "object" && !a.isFunction(u[0]) ? a
					.extend(a.jgrid.inlineEdit, h, u[0]) : h;
			return this.each(function() {
				var g = this, f, o, x = 0, y = null, w = {}, p, j;
				if (g.grid) {
					p = a(g).jqGrid("getInd", c, true);
					if (p !== false)
						if ((a(p).attr("editable") || "0") == "0"
								&& !a(p).hasClass("not-editable-row")) {
							j = g.p.colModel;
							a('td[role="gridcell"]', p).each(function(k) {
								f = j[k].name;
								var A = g.p.treeGrid === true
										&& f == g.p.ExpandColumn;
								if (A)
									...
									try {
										...
										o = j[k].edittype
												&& j[k].edittype == "textarea"
												? a(this).text()
												: a(this).html()
									}
								if (f != "cb" && f != "subgrid" && f != "rn") {
									if (g.p.autoencode)
										o = a.jgrid.htmlDecode(o);
									w[f] = o;
									if (j[k].editable === true) {
										...
										A
												? a("span:first", this)
														.html("")
												: a(this).html("");
										var n = a.extend({}, j[k].editoptions
														|| {}, {
													id : c + "_" + f,
													name : f
												});
										...
										if (o == "&nbsp;" || o == "&#160;"
												...
												&& o.charCodeAt(0) == 160)
											o = "";
										n = a.jgrid.createEl(j[k].edittype, n,
												o, true, a.extend({},
														a.jgrid.ajaxOptions,
							...
							if (x > 0) {
								...
								g.p.savedRow.push(w);
								a(p).attr("editable", "1");
								a("td:eq(" + y + ") input", p).focus();
								e.keys === true
										&& a(p).bind("keydown", function(k) {
											if (k.keyCode === 27) {
												a(g).jqGrid("restoreRow", c, t);
												return false
											}
											if (k.keyCode === 13) {
												if (k.target.tagName == "TEXTAREA")
													return true;
												a(g).jqGrid("saveRow", c, e);
												return false
											}
										});
								a.isFunction(e.oneditfunc)
										&& e.oneditfunc.call(g, c)
							}
						}
				}
			})
		},
		saveRow : function(c, d, b, i, q, l, s) {
			var m = {
				successfunc : d || null,
				url : b || null,
				extraparam : i || {},
				aftersavefunc : q || null,
				errorfunc : l || null,
			...
			h = t[0] && typeof t[0] == "object" && !a.isFunction(t[0]) ? a
					.extend(a.jgrid.inlineEdit, m, t[0]) : m;
			var u = false, e = this[0], g, f = {}, o = {}, x = {}, y, w, p;
			if (!e.grid)
				return u;
			p = a(e).jqGrid("getInd", c, true);
			if (p === false)
				return u;
			m = a(p).attr("editable");
			h.url = h.url ? h.url : e.p.editurl;
			if (m === "1") {
				var j;
				a('td[role="gridcell"]', p).each(function(r) {
					j = e.p.colModel[r];
					g = j.name;
					if (g != "cb" && g != "subgrid" && j.editable === true
							&& g != "rn"
						...
						switch (j.edittype) {
							case "checkbox" :
								var n = ["Yes", "No"];
								if (j.editoptions)
									n = j.editoptions.value.split(":");
								f[g] = a("input", this).is(":checked")
										? n[0]
										: n[1];
								break;
							case "text" :
							...
							case "select" :
								if (j.editoptions.multiple) {
									...
									f[g] = a("select option:selected", this)
											.val();
									o[g] = a("select option:selected", this)
											.text()
								}
								if (j.formatter && j.formatter == "select")
									o = {};
								break;
							case "custom" :
								try {
									if (j.editoptions
										...
										f[g] = j.editoptions.custom_value.call(
												e, a(".customelement", this),
												"get");
										if (f[g] === undefined)
											throw "e2";
									} else
											...
											&& a.jgrid
													.info_dialog(
															...
															"function 'custom_value' "
																	+ a.jgrid.edit.msg.nodefined,
															jQuery.jgrid.edit.bClose);
									z == "e2" ? a.jgrid.info_dialog(
											jQuery.jgrid.errors.errcap,
											"function 'custom_value' "
													+ a.jgrid.edit.msg.novalue,
											jQuery.jgrid.edit.bClose) : a.jgrid
											.info_dialog(
													jQuery.jgrid.errors.errcap,
													z.message,
													jQuery.jgrid.edit.bClose)
						...
						w = a.jgrid.checkValues(f[g], r, e);
						if (w[0] === false) {
							w[1] = f[g] + " " + w[1];
							return false
						}
						if (e.p.autoencode)
							f[g] = a.jgrid.htmlEncode(f[g]);
						if (h.url !== "clientArray" && j.editoptions
				...
				if (w[0] === false) {
					try {
						var k = a.jgrid.findPos(a("#" + a.jgrid.jqID(c),
								e.grid.bDiv)[0]);
						a.jgrid.info_dialog(a.jgrid.errors.errcap, w[1],
								a.jgrid.edit.bClose, {
									left : k[0],
									top : k[1]
								})
				...
				if (f) {
					f[t] = m.editoper;
					f[k] = c;
					if (typeof e.p.inlineData == "undefined")
						e.p.inlineData = {};
					f = a.extend({}, f, e.p.inlineData, h.extraparam)
				}
				if (h.url == "clientArray") {
					f = a.extend({}, f, o);
					e.p.autoencode && a.each(f, function(r, n) {
								f[r] = a.jgrid.htmlDecode(n)
							});
					k = a(e).jqGrid("setRowData", c, f);
					a(p).attr("editable", "0");
					for (m = 0; m < e.p.savedRow.length; m++)
						if (e.p.savedRow[m].id == c) {
							y = m;
							break
						}
					y >= 0 && e.p.savedRow.splice(y, 1);
					a.isFunction(h.aftersavefunc)
							&& h.aftersavefunc.call(e, c, k);
					u = true;
					a(p).unbind("keydown")
				} else {
					a("#lui_" + e.p.id).show();
					x = a.extend({}, f, x);
					x[k] = a.jgrid.stripPref(e.p.idPrefix, x[k]);
					a.ajax(a.extend({
								url : h.url,
								data : a.isFunction(e.p.serializeRowData)
										? e.p.serializeRowData.call(e, x)
										: x,
								type : h.mtype,
								async : false,
								complete : function(r, n) {
									...
									if (n === "success") {
										var v = true, z;
										if (a.isFunction(h.successfunc)) {
											z = h.successfunc.call(e, r);
											if (a.isArray(z)) {
												v = z[0];
												f = z[1] ? z[1] : f
											} else
										...
										if (v === true) {
											...
											f = a.extend({}, f, o);
											a(e).jqGrid("setRowData", c, f);
											a(p).attr("editable", "0");
											for (v = 0; v < e.p.savedRow.length; v++)
												if (e.p.savedRow[v].id == c) {
													y = v;
													break
												}
											y >= 0 && e.p.savedRow.splice(y, 1);
											a.isFunction(h.aftersavefunc)
													&& h.aftersavefunc.call(e,
															c, r);
											u = true;
											a(p).unbind("keydown")
										} else {
											a.isFunction(h.errorfunc)
													&& h.errorfunc.call(e, c,
															r, n);
								...
								error : function(r, n) {
									a("#lui_" + e.p.id).hide();
									if (a.isFunction(h.errorfunc))
										h.errorfunc.call(e, c, r, n);
									else
										try {
									...
									h.restoreAfterError === true
											&& a(e).jqGrid("restoreRow", c,
													h.afterrestorefunc)
								}
							}, a.jgrid.ajaxOptions, e.p.ajaxRowOptions || {}))
				}
			}
			return u
		},
		restoreRow : function(c, d) {
			var b = {
				afterrestorefunc : d || null
			}, i = a.makeArray(arguments).slice(1), q;
			q = i[0] && typeof i[0] == "object" && !a.isFunction(i[0]) ? a
					.extend(a.jgrid.inlineEdit, b, i[0]) : b;
			return this.each(function() {
				var l = this, s, m, t = {};
				if (l.grid) {
					m = a(l).jqGrid("getInd", c, true);
					if (m !== false) {
						for (var h = 0; h < l.p.savedRow.length; h++)
							if (l.p.savedRow[h].id == c) {
								s = h;
								break
							}
						if (s >= 0) {
							...
							a.each(l.p.colModel, function() {
										if (this.editable === true
												&& this.name in l.p.savedRow[s]
												&& !a(this)
														.hasClass("not-editable-cell"))
											t[this.name] = l.p.savedRow[s][this.name]
									});
							a(l).jqGrid("setRowData", c, t);
							a(m).attr("editable", "0").unbind("keydown");
							l.p.savedRow.splice(s, 1);
							a("#" + a.jgrid.jqID(c), "#" + a.jgrid.jqID(l.p.id))
									.hasClass("jqgrid-new-row")
									&& setTimeout(function() {
												a(l).jqGrid("delRowData", c)
											}, 0)
						}
						a.isFunction(q.afterrestorefunc)
								&& q.afterrestorefunc.call(l, c)
					}
				}
			})
		},
							...
							c.useDefValues === true
									&& a(d.p.colModel).each(function() {
										if (this.edioptions
											...
											var i = this.editoptions.defaultValue;
											i = a.isFunction(i) ? i.call(d) : i;
											c.initdata[this.name] = i
										}
									});
							a(d).jqGrid("addRowData", c.rowID, c.initdata,
									c.position);
			...
			return this.each(function() {
				if (this.grid) {
					...
					if (d.addParams.useFormatter === true) {
						var i = b.p.colModel, q;
						for (q = 0; q < i.length; q++)
							if (i[q].formatter && i[q].formatter === "actions") {
								if (i[q].formatoptions) {
									i = a.extend({
												keys : false,
												onEdit : null,
												onSuccess : null,
					...
					d.edit && a(b).jqGrid("navButtonAdd", c, {
						...
						id : b.p.id + "_iledit",
						onClickButton : function() {
							var l = a(b).jqGrid("getGridParam", "selrow");
							if (l) {
								a(b).jqGrid("editRow", l, d.editParams);
								a("#" + b.p.id + "_ilsave")
										.removeClass("ui-state-disabled");
								a("#" + b.p.id + "_ilcancel")
										.removeClass("ui-state-disabled");
							...
							onClickButton : function() {
								...
								if (l) {
									if (a("#" + a.jgrid.jqID(l),
											"#" + a.jgrid.jqID(b.p.id))
											.hasClass("jqgrid-new-row")) {
										var s = b.p.prmNames, m = s.oper;
										if (!d.editParams.extraparam)
											d.editParams.extraparam = {};
										d.editParams.extraparam[m] = s.addoper
									}
									a(b).jqGrid("saveRow", l, d.editParams);
									a("#" + b.p.id + "_ilsave")
											.addClass("ui-state-disabled");
									a("#" + b.p.id + "_ilcancel")
											.addClass("ui-state-disabled");
					...
					if (d.cancel) {
						a(b).jqGrid("navButtonAdd", c, {
							...
							onClickButton : function() {
								var l = a(b).jqGrid("getGridParam", "selrow");
								if (l) {
									a(b).jqGrid("restoreRow", l, d.editParams);
									a("#" + b.p.id + "_ilsave")
											.addClass("ui-state-disabled");
									a("#" + b.p.id + "_ilcancel")
											.addClass("ui-state-disabled");
					...
					if (!(h == "subgrid" || h == "cb" || h == "rn")) {
						...
						if (i.editable === true && a === true
							...
							try {
								...
								e = i.edittype && i.edittype == "textarea"
										? b(g).text()
										: b(g).html()
							}
							if (c.p.autoencode)
							...
							var m = b.jgrid.createEl(i.edittype, j, e, true,
									b.extend({}, b.jgrid.ajaxOptions,
											c.p.ajaxSelectOptions || {}));
							...
							if (b.isFunction(c.p.onSelectCell)) {
								...
								c.p.onSelectCell.call(c, c.rows[d].id, h, e, d,
										f)
							}
						}
						c.p.iCol = f;
							...
							if (r[0] === true) {
								...
								if (a.p.cellsubmit == "remote")
									if (a.p.cellurl) {
										...
										i = l.id;
										j = l.oper;
										n[i] = b.jgrid.stripPref(a.p.idPrefix,
												a.rows[d].id);
										n[j] = l.editoper;
										n = b.extend(c, n);
										b("#lui_" + a.p.id).show();
								...
								if (a.p.cellsubmit == "clientArray") {
									b(h).empty();
									b(a).jqGrid("setCell", a.rows[d].id, f, g,
											false, false, true);
...
(function(b) {
	b.jgrid.extend({
		...
		addSubGridCell : function(f, d) {
			...
			return '<td role="grid" aria-describedby="' + s
			...
			return this.each(function() {
				...
				if (a.grid) {
					var n = function(g, j, e) {
						j = b("<td align='" + a.p.subGridModel[0].align[e]
								+ "'></td>").html(j);
						b(g).append(j)
					}, s = function(g, j) {
										...
										function() {
											...
											if (b(this).hasClass("sgcollapsed")) {
												...
												if (p === false)
													return false;
												if (a.p.subGridOptions.reloadOnExpand === true)
													b(q).remove(".ui-subgrid");
												else
													b(q).hasClass("ui-subgrid")
															&& b(q).hide();
												b(this)
														.html("<a href='javascript:void(0);'><span class='ui-icon "
...
(function(e) {
	e.jgrid.extend({
						...
						for (var c = 0; c < a.groupField.length; c++) {
							...
							if (a.groupSummary[c]) {
								...
								for (var b = this.p.colModel, d = 0, g = b.length; d < g; d++)
									b[d].summaryType && a.summary[c].push({
												nm : b[d].name,
												st : b[d].summaryType,
												v : ""
											})
		...
		groupingPrepare : function(a, c, b, d) {
			this.each(function() {
				...
				h.groupSummary[0] && e.each(h.summaryval[0][g], function() {
							this.v = e.isFunction(this.st) ? this.st.call(f,
									this.v, this.nm, d) : e(f).jqGrid(
		...
		groupingToggle : function(a) {
			this.each(function() {
				var c = this.p.groupingView, b = a.lastIndexOf("_"), d = a
						.substring(0, b + 1);
				b = parseInt(a.substring(b + 1), 10) + 1;
				var g = c.minusicon, h = c.plusicon, f = e("#" + a);
				f = f.length ? f[0].nextSibling : null;
				var k = e("#" + a + " span.tree-wrap-" + this.p.direction), l = false;
				if (k.hasClass(g)) {
		...
		groupingRender : function(a, c) {
			return this.each(function() {
				var b = this, d = b.p.groupingView, g = "", h = "", f, k = d.groupCollapse
						? d.plusicon
						: d.minusicon, l, r, m;
				...
				e.each(d.sortitems[0], function(o, n) {
					f = b.p.id + "ghead_" + o;
					h = "<span style='cursor:pointer;' class='ui-icon " + k
							+ "' onclick=\"jQuery('#" + b.p.id
							+ "').jqGrid('groupingToggle','" + f
							+ "');return false;\"></span>";
					try {
						l = b
								.formatter(f, d.sortnames[0][o], r,
										d.sortitems[0])
					} catch (v) {
						l = d.sortnames[0][o]
					}
					g += '<tr id="'
							...
							+ b.p.direction + '"><td colspan="' + c + '">' + h
							+ e.jgrid.format(d.groupText[0], l, a[n].length)
							+ "</td></tr>";
										...
										if (this.nm == p[j].name) {
											...
											if (this.st == "avg")
												if (this.v && s > 0)
													this.v /= s;
											try {
												q = b.formatter("", this.v, j,
														this)
											} catch (w) {
												q = this.v
											}
											t = "<td " + b.formatCol(j, 1, "")
													+ ">"
													+ e.jgrid.format(u, q)
													+ "</td>";
											return false
		...
		groupingGroupBy : function(a, c) {
			return this.each(function() {
						...
						for (d = 0; d < a.length; d++)
							b.visibiltyOnNextGrouping[d] = e("#" + this.p.id
									+ "_" + a[d]).is(":visible");
			...
			return this.each(function() {
				...
				if (a === true) {
					for (var c = this.p.groupingView, b = 0; b < c.groupField.length; b++)
						!c.groupColumnShow[b] && c.visibiltyOnNextGrouping[b]
								&& e(this).jqGrid("showCol", c.groupField);
					e("tr.jqgroup, tr.jqfoot", "#" + this.p.id + " tbody:first")
							.remove();
					e("tr.jqgrow:hidden", "#" + this.p.id + " tbody:first")
							.show()
				} else
					e(this).trigger("reloadGrid")
			})
...
(function(d) {
	d.jgrid.extend({
			...
			return this.each(function() {
				...
				if (b.grid && b.p.treeGrid)
					for (var e = b.p.expColInd, g = b.p.treeReader.expanded_field, h = b.p.treeReader.leaf_field, f = b.p.treeReader.level_field, l = b.p.treeReader.icon_field, i = b.p.treeReader.loaded, j, o, n, k; a < c;) {
						...
						n = "<div class='tree-wrap tree-wrap-" + b.p.direction
								+ "' style='width:" + n * 18 + "px;'>";
						n += "<div style='"
								+ (b.p.direction == "rtl" ? "right:" : "left:")
								+ o * 18 + "px;' class='ui-icon ";
						if (k[i] !== undefined)
							k[i] = k[i] == "true" || k[i] === true
									? true
									: false;
						...
						k[g] = (k[g] == "true" || k[g] === true ? true : false)
								&& k[i];
						n += k[g] === false
								? k[h] === true ? "'" : b.p.treeIcons.plus
										+ " tree-plus treeclick'"
								: k[h] === true ? "'" : b.p.treeIcons.minus
										+ " tree-minus treeclick'";
						n += "></div></div>";
						d(b.rows[a].cells[e])
								.wrapInner("<span class='cell-wrapper" + o
										+ "'></span>").prepend(n);
						if (j !== parseInt(b.p.tree_root_level, 10))
							(k = (k = d(b).jqGrid("getNodeParent", k))
									&& k.hasOwnProperty(g) ? k[g] : true)
									|| d(b.rows[a]).css("display", "none");
						d(b.rows[a].cells[e]).find("div.treeclick").bind(
								"click", function(m) {
									m = d(m.target || m.srcElement, b.rows)
											.closest("tr.jqgrow")[0].id;
									m = b.p._index[m];
									if (!b.p.data[m][h])
										if (b.p.data[m][g]) {
											d(b).jqGrid("collapseRow",
													b.p.data[m]);
											d(b).jqGrid("collapseNode",
													b.p.data[m])
										} else {
											d(b).jqGrid("expandRow",
													b.p.data[m]);
											d(b).jqGrid("expandNode",
													b.p.data[m])
										}
									return false
								});
		...
		expandRow : function(a) {
			this.each(function() {
				...
				if (c.grid && c.p.treeGrid) {
					...
					d(b).each(function() {
								var g = d.jgrid.getAccessor(this,
										c.p.localReader.id);
				...
				if (c.grid && c.p.treeGrid)
					switch (c.p.treeGridModel) {
						...
						case "adjacency" :
							...
							d(c.p.data).each(function() {
								if (this[e] === null
										|| String(this[e]).toLowerCase() == "null")
									a.push(this)
							})
					}
			});
					...
					switch (this.p.treeGridModel) {
						case "nested" :
							var b = this.p.treeReader.left_field, e = this.p.treeReader.right_field, g = this.p.treeReader.level_field, h = parseInt(
									a[b], 10), f = parseInt(a[e], 10), l = parseInt(
									a[g], 10);
							d(this.p.data).each(function() {
								if (parseInt(this[g], 10) === l - 1
										&& parseInt(this[b], 10) < h
					...
					switch (this.p.treeGridModel) {
						case "nested" :
							var e = this.p.treeReader.left_field, g = this.p.treeReader.right_field, h = this.p.treeReader.level_field, f = parseInt(
									a[e], 10), l = parseInt(a[g], 10), i = parseInt(
									a[h], 10);
							d(this.p.data).each(function() {
								parseInt(this[h], 10) >= i
										&& parseInt(this[e], 10) >= f
		...
		getNodeAncestors : function(a) {
			...
			this.each(function() {
						if (this.grid && this.p.treeGrid)
							for (var b = d(this).jqGrid("getNodeParent", a); b;) {
								c.push(b);
		...
		expandNode : function(a) {
			return this.each(function() {
				if (this.grid && this.p.treeGrid) {
					...
					if (!a[c]) {
						var l = d.jgrid.getAccessor(a, this.p.localReader.id), i = d(
					...
					if (l !== undefined) {
						...
						if (l.length > 0)
							for (var i = 0; i < l.length; i++)
								d(this).jqGrid("delRowData", l[i][c]);
						if (this.p.treeGridModel === "nested") {
							...
							if (c.length)
								for (f in c)
									c[f][b] = parseInt(c[f][b], 10) - h;
							c = d.jgrid.from(this.p.data).greater(e, g, {
										stype : "integer"
									}).select();
							if (c.length)
								for (f in c)
									c[f][e] = parseInt(c[f][e], 10) - h
						}
					}
				}
			})
			...
			if (b) {
				...
				if (e.p.treeGridModel === "nested") {
					...
					if (c !== null) {
						...
						if (f.length)
							for (q in f) {
								f[q][i] = f[q][i] > h ? parseInt(f[q][i], 10)
										+ 2 : f[q][i];
								f[q][j] = f[q][j] >= h ? parseInt(f[q][j], 10)
										+ 2 : f[q][j]
							}
						b[i] = h;
						b[j] = h + 1
	...
	jQuery(n).each(function() {
		if (!this.grid) {
			...
			var a = jQuery(this).width(), d = jQuery(
					...
					"tr td:first-child input[type=radio]:first", jQuery(this));
			d = d.length > 0;
			b = !d && b.length > 0;
			var l = d || b, c = [], g = [];
		...
		sortableColumns : function(b) {
			return this.each(function() {
				...
				f = {
					...
					axis : "x",
					scrollSensitivity : "1",
					items : ">th:not(:has(#jqgh_" + f + "_cb,#jqgh_" + f
							+ "_rn,#jqgh_" + f + "_subgrid),:hidden)",
					placeholder : {
						element : function(g) {
							return a(document.createElement(g[0].nodeName))
									.addClass(g[0].className
											+ " ui-sortable-placeholder ui-state-highlight")
									.removeClass("ui-sortable-helper")[0]
						},
						update : function(g, j) {
							j.height(g.currentItem.innerHeight()
									- parseInt(g.currentItem.css("paddingTop")
													|| 0, 10)
									- parseInt(g.currentItem
													.css("paddingBottom")
													|| 0, 10));
							j.width(g.currentItem.innerWidth()
									- parseInt(g.currentItem.css("paddingLeft")
													|| 0, 10)
									- parseInt(g.currentItem
													.css("paddingRight")
													|| 0, 10))
					...
					update : function(g, j) {
						...
						var d = [];
						i.each(function() {
									var k = a(">div", this).get(0).id.replace(
											/^jqgh_/, "").replace(m, "");
									k in l && d.push(l[k])
								});
		...
		columnChooser : function(b) {
			function h(d, k) {
				if (d)
					if (typeof d == "string")
						a.fn[d]
								&& a.fn[d].apply(k, a.makeArray(arguments)
												.slice(2));
					else
						a.isFunction(d)
								&& d.apply(k, a.makeArray(arguments).slice(2))
			}
			var c = this;
			if (!a("#colchooser_" + c[0].p.id).length) {
				...
				var g = c.jqGrid("getGridParam", "colModel"), j = c.jqGrid(
						"getGridParam", "colNames"), i = {}, l = [];
				e.empty();
				a.each(g, function(d) {
							i[this.name] = d;
							if (this.hidedlg)
				...
				var m = a.isFunction(b.dlog_opts)
						? b.dlog_opts.call(c, b)
						: b.dlog_opts;
				h(b.dlog, f, m);
				m = a.isFunction(b.msel_opts)
						? b.msel_opts.call(c, b)
						: b.msel_opts;
				h(b.msel, e, m)
			}
		},
					...
					if (!h.p.treeGrid)
						if (a.fn.sortable) {
							...
							b.update = function(c, f) {
								...
								h.p.rownumbers === true
										&& a("td.jqgrid-rownum", h.rows).each(
												function(e) {
													a(this).html(e
															+ 1
															+ (parseInt(
			...
			return this.each(function() {
				function h() {
					...
					a("tr.jqgrow:not(.ui-draggable)", c)
							.draggable(a.isFunction(e.drag) ? e.drag.call(a(c),
									e) : e.drag)
				}
				var c = this;
				if (c.grid)
						...
						if (h.grid && a.fn.resizable) {
							...
							b.stop = function(c, f) {
								a(h).jqGrid("setGridParam", {
									height : a("#gview_" + h.p.id
											+ " .ui-jqgrid-bdiv").height()
								});
								a(h).jqGrid("setGridWidth", f.size.width,
										b.shrinkToFit);
							...
							b.alsoResize = b._alsoResize_
									? eval("("
											+ ("{'#gview_"
													...
													+ b._alsoResize_ + "':true}")
											+ ")")
									: a(".ui-jqgrid-bdiv", "#gview_" + h.p.id);
...
/*
 * 设置jqgrid默认属性 Copyright (c) 2011,Zhang Qiang, james.zhangq@gmail.com
 * http://www.tocersoft.com Date: 2011-04-28
 */
(function($) {
	// 设置全局默认属性
	$.extend($.jgrid.defaults, {
				...
				prmNames : {
					...
					page : "pageResult.currentPage",
					sort : "pageResult.orderBy",
					order : "pageResult.sort"
				},
				...
				loadError : function(xhr, status, error) {
					...
					if (msg.indexOf("top.location.href") != -1) { // 会话超时
						...
						$.dialog.alert("你长时间未操作，系统已锁定，请重新登录");
					}
				}
			});
