$(document).ready(function($){
				...
				$(".picwrap li").eq(0).css("display","block");
			...
			$('.ifeng-list li a').mouseover(function(){
				$('.ifeng-list .a-hover').removeClass('a-hover');
				var i = $(this).parent().index();
				$(this).addClass('a-hover');
				$('.ifeng-list .ifeng-item').hide();
				$('.ifeng-list .ifeng-item').eq(i).show();
			});
		});