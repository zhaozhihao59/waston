...
(function (e) {
	e.fn.mogFocus = function (t) {
		...
		return this.each(function () {
			...
			function P() {
				p.animate({marginLeft:-u, opacity:0.8}, n.prevNextAnima), d.animate({marginRight:-u, opacity:0.8}, n.prevNextAnima);
			}
			function H() {
			...
			function q() {
				h.hide(), t.css({top:Math.round(s / 2), height:0, display:"block"}).delay(700).animate({top:0, height:s}, {duration:1000, easing:"easeInOutQuart", complete:function () {
					h.fadeIn(600), n.prevNextToggle == "show" && P();
				}});
			}
			function R() {
				t.css("display", "block"), n.prevNextToggle == "show" && (p.css({marginLeft:-u, opacity:0.8}), d.css({marginRight:-u, opacity:0.8}));
			}
			...
			p.css({marginLeft:-(u + n.prevNextPos), opacity:0}), d.css({marginRight:-(u + n.prevNextPos), opacity:0}), n.scrollWidth == "100%" || n.scrollWidth == "auto" ? h.css(n.thumCSS) : h.css("right", 0);
			...
			t.hover(function () {
				...
				e(this).fadeTo(300, 0.6);
			}, function () {
				e(this).fadeTo(300, 0.8);
	...
	}, e.fn.mogFocus.defaults = {loadAnimation:!0, loadswitch:!1, loading:"images/loading.gif", time:3000, scrollWidth:"100%", autoScroll:!0, conversionImg:!0, animationWay:"lrSliding", prevNextPos:70, prevNextAnima:{duration:600, easing:"easeInOutBack"}, prevNextToggle:"show", btnStyle:"thumbnail", thumWidth:90, thumHeight:36, thumlen:5, thumCSS:{right:"50%", "margin-right":-529}, thumSubsty:{border:"1px solid #ccc", padding:1, background:"#fff"}, thumSelected:{border:"1px solid #6d6d6d", background:"#fff"}, single:!0, focusDelay:0, focusDelayTwo:200, focusTime:{duration:1300, easing:"easeInOutQuart"}, focusTwoTime:{duration:1300, easing:"easeInOutQuart"}, fadeTime:400, fadeTwoTime:600, randomsImgTime:600, randeasing:"easeInOutBack"};
})(jQuery);
