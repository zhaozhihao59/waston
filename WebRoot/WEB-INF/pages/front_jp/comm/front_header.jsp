		...
		<div class="w1170-mg-auto clb pr" style="z-index:9000;">
			...
			<div class="wa-search-bar fr">
				<div class="form-group fl">
					<input id="searchName" type="text" style="width:185px;" class="form-control" placeholder="搜索 &hellip;" onkeypress="if(event.keyCode == 13){quickSearch();}"  value="${searchName }">
				</div>
...
<script>
 ...
 $("#showDate").html("時間:"+d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()+" "+d.getDate()+"-"+(d.getMonth()+1)+"-"+ d.getFullYear());
	...
	$("#search").click(function (){
		...
		window.location.href = "${BASE_PATH}jp/search_jp.htm?searchName="+searchName;
	});
	//回车搜索
