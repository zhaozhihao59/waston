	...
	<body>
		...
		<div class="w1170-mg-auto clb">
			<div class="scl-knowledge-showbox">
				...
				<div id="hcActive">
					<jsp:include page="/WEB-INF/pages/front_jp/search_result_inc.jsp"></jsp:include>
				</div>
			...
			$(function(){
				$(function(){
					$(".knowledge-ul li").each(function(i){
						$(".scl-knowledge-showbox").eq(0).animate({opacity:'1',marginTop:'0'},1000).show().siblings(".scl-knowledge-showbox").hide();
						$(this).click(function(){
							$(this).addClass("cur").siblings().removeClass("cur");
							$(".scl-knowledge-showbox").eq(i).css("opacity",0);
