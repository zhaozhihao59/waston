...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
				...
				<div class="news-item">
					<div class="news-title">
						<a target="_blank" class="news-title-a" href="jp/cmsDetail_jp.htm?item.id=${pr.id}">${pr.jpName}</a>
					</div>
					<div class="news-brief">
						...
						<div class="news-content fl">
							<div class="news-data">
								...
								<span class="news-publisher">発表者：${pr.authorJp}</span>
								<span class="news-count">閲覧回数：${pr.readNum}次</span>
							</div>
							<div class="news-remark fl">
								<a target="_blank" class="news-remark-a" href="jp/cmsDetail_jp.htm?item.id=${pr.id}">
									${pr.jpSummary}
								</a>
							</div>
						</div>
