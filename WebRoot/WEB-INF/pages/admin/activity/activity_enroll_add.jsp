...
<html>
	...
	<body class="iframe-body">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td class="form-content" width="30%">
					<input id="activityName" name="item.activityName" value="${item.name }"  class="tc-input-text w" type="text"/>
				</td>
		...
		<a id="updateBtn" class="ui_button" href="javascript:void(0);" onclick="saveActivity();">保存修改</a>
		</s:form>
		
		<script type="text/javascript" src="static/admin/activity/activity_enroll_add.js"></script>
	</body>
</html>