			...
			<div class="job-opp-cbox mt20" style="display:inline-block;">
				<div class="scl-knowledge-showbox" >
					...
					<div style="padding:30px;">
						<!-- <div id="allmap"></div> -->
						<div><img src="${BASE_PATH}/static/front/comm/images/map1.jpg"></div>
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">地址</div>
								<div class="contact-tbox">上海市长乐路989号世纪商贸广场26楼 邮编：200031</div>
								<div class="contact-tbox">电话： (86-21) 5292-1111; (86-21) 6350-0777</div>
								<div class="contact-tbox">传真： (86-21)5292-1001; (86-21) 6272-6366</div>
								...
								<div class="contact-tbox">网址：<a href="http://www.watson-band.com.cn">www.watson-band.com.cn</a></div>
								<div class="contact-tbox">监督电话： （86-21）5292-1111 * 126</div>
							</div>
				...
				<div class="scl-knowledge-showbox none">
					...
					<div style="padding:30px;">
						...
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">地址</div>
								<div class="contact-tbox">北京市东城区朝阳门北大街8号富华大厦D座5C 邮编：100027</div>
								<div class="contact-tbox">电话： (86-10) 66256025</div>
								<div class="contact-tbox">传真： (86-10) 6445-2797</div>
								...
								<div class="contact-tbox">网址：<a href="http://www.watson-band.com.cn">www.watson-band.com.cn</a></div>
								<div class="contact-tbox">监督电话： （86-10）6625-6025 * 601</div>
							</div>
<!-- 							<div class="fr" style="width:320px;"> -->
<!-- 								<div class="yq-ttbox mb15">交通路线</div> -->
<!-- 								<div class="contact-tbox">地铁一号线陕西路站2号出口步行15分钟</div> -->
				...
				<div class="scl-knowledge-showbox none">
					...
					<div style="padding:30px;">
						...
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">地址</div>
								<div class="contact-tbox">哈尔滨市道里区西八道街37号马迪尔大厦18层A2室 邮编：150010</div>
								<div class="contact-tbox">电话： (86-451) 8457-3032</div>
				...
				<div class="scl-knowledge-showbox none">
					...
					<div style="padding:30px;">
						...
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">地址</div>
								<div class="contact-tbox">香港中环荷李活道32号建业荣基中心2004室</div>
								<div class="contact-tbox">电话： (86-21) 5292-1111*123; 852-3197-0091</div>
								<div class="contact-tbox">传真： (86-21) 5292-1001; 852-3197-0093</div>
