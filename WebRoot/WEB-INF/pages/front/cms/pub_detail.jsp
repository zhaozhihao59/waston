...
<body>
	...
	<div class="act-index-middlebox">
		...
		<input id="cmsArticle" type="hidden" value="${item.annexPath}">
		...
		<div class="fr actright-box" style="padding-bottom:10px;">
			<div class="cms-right-box">
				...
				<div class="news-data mt10">
					...
					<span class="news-publisher">发布人：发布人：${item.author }</span>
					<%-- <span class="news-count">阅读量：30次</span> --%>
					<a  onclick="dowloadFile()" href="javascript:void(0);"  class="xz-pdfico">下载PDF文件</a>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function dowloadFile(){
		...
		window.location.href = basePath+"dowloadFile.htm?selIds="+selIds;
	}
</script>
</html>
