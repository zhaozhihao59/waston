...
<script type="text/javascript" src="static/front/comm/bm-active.js"></script>
...
<div class="msg-box-content none" id="massageDiv" >
	<s:form id="regeisterForm" method="post" >
		...
		<div class="mb-content">
			<div style="color:#999">请填写您的联系信息。</div>
		...
		<div class="form-item">
			<span class="item-title w80"><em>*</em>手机：</span>
		...
		<div class="form-item">
			...
			<a href="javaScript:void(0);" class="ljbm-btn fl "  onClick ="regeisterNow();">保存并提交</a>
			<a href="javaScript:void(0);" class="ljbm-btn fl ml10" onClick ="regeisterTongxingNow();return false;">提交并添加同行人</a>
		</div>
	</div>
		</div>
		</s:form>
