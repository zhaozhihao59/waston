...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
				...
				<div class="news-item">
					<div class="news-title">
						<a target="_blank" class="news-title-a" href="en/cmsDetail_en.htm?item.id=${pr.id}">${pr.enName}</a>
					</div>
					<div class="news-brief">
						
						<div class="news-content fl">
							<div class="news-data">
								<span class="news-date"><fmt:formatDate value="${pr.createDate}" pattern="yyyy-MM-dd"/><br> </span>
								<span class="news-publisher">Published by：${pr.authorEn}</span>
								<span class="news-count">Amount of reading：${pr.readNum}次</span>
							</div>
							<div class="news-remark fl">
								<a target="_blank" class="news-remark-a" href="en/cmsDetail_en.htm?item.id=${pr.id}">
									${pr.enSummary}
								</a>
							</div>
						</div>
