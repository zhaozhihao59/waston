...
<body>
	...
	<div class="act-index-middlebox">
		<div class="fl act-left-box">
			...
			<div class="act-tt-box">ABOUT US</div>
		...
		<div class="fr actright-box">
			...
			<div class="knowledge-ccbox mt20">
				Watson & Band maintains offices in Shanghai, Beijing, Harbin and Hong Kong.      
			</div>
			...
			<div class="job-opp-cbox mt20" style="display:inline-block;">
				<div class="scl-knowledge-showbox" >
					...
					<div style="padding:30px;">
						<!-- <div id="allmap"></div> -->
						<div><img src="${BASE_PATH}/static/front_en/comm/images/map1.jpg"></div>
						<div class="mt30">
							<div class="fl" style="width:310px;">
								<div class="yq-ttbox mb15">Address:</div>
								<div class="contact-tbox">LOCATION: 26th Floor, The Center, No.989 Changle Road, Shanghai  200031 P.R.C.</div>
								<div class="contact-tbox">Tel： (86-21) 5292-1111; (86-21) 6350-0777</div>
								<div class="contact-tbox">Fax: (86-21)5292-1001; (86-21) 6272-6366</div>
								...
								<div class="contact-tbox">Website：<a href="http://www.watson-band.com.cn">www.watson-band.com.cn</a></div>
								<div class="contact-tbox">For comments or suggestions, please dial： （86-21）5292-1111 * 126</div>
							</div>
					...
					<div style="padding:30px;">
						...
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">Address:</div>
								<div class="contact-tbox">5C, D Block, Fuhua Mansion, No. 8 North Chaoyangmen Street, Dongcheng District, Beijing 100027 P.R.C.</div>
								<div class="contact-tbox">Tel： (86-10) 66256025</div>
								<div class="contact-tbox">Fax:： (86-10) 6445-2797</div>
								...
								<div class="contact-tbox">Website：<a href="http://www.watson-band.com.cn">www.watson-band.com.cn</a></div>
								<div class="contact-tbox">For comments or suggestions, please dial： （86-10）6625-6025 * 601</div>
							</div>
<!-- 							<div class="fr" style="width:320px;"> -->
<!-- 								<div class="yq-ttbox mb15">交通路线</div> -->
<!-- 								<div class="contact-tbox">地铁一号线陕西路站2号出口步行15分钟</div> -->
				...
				<div class="scl-knowledge-showbox none">
					...
					<div style="padding:30px;">
						...
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">Address:</div>
								<div class="contact-tbox">•	Room A2, Madieer Shopping Center No.37 West Badao Street, Daoli District, Harbin 150010 P.R.C.</div>
								<div class="contact-tbox">Tel： (86-451) 8457-3032</div>
				...
				<div class="scl-knowledge-showbox none">
					...
					<div style="padding:30px;">
						...
						<div class="mt30">
							<div class="fl" style="width:510px;">
								<div class="yq-ttbox mb15">Address：</div>
								<div class="contact-tbox">•	Room 2004, Kinwick Center, 32 Hollywood Road, Central District, Hong Kong</div>
								<div class="contact-tbox">Tel： (86-21) 5292-1111*123; 852-3197-0091</div>
								<div class="contact-tbox">Fax:： (86-21) 5292-1001; 852-3197-0093</div>
