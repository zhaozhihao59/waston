...
<div class="sctr-right-box">
	<div class="srb-nav-box fl">Legal Research</div>
...
<c:forEach var="article" items="${pageResult.result}">
	<div class="news-item mt20">
		<div class="news-title">
			<a class="news-title-a" href="en/pubDetail_en.htm?item.id=${article.id }">${article.enName }</a>
		</div>
	...
	<!-- 页数一部提交 -->
	 <script type="text/javascript">
		$(".pageReslt").click(function (){
			...
			var id = $("#itemId").val();
			// 相关证书异步请求
			$.post(base+"en/pub_ListPage_page_en.htm",{"page":currentPage},function(data){
			 	$("#hcActive").html(data);
			});
		}) ;
