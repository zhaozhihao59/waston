...
<body>
	...
	<div class="act-index-middlebox">
		...
		<div id="hcActive">
			<jsp:include page="/WEB-INF/pages/front_en/cms/pub_index_inc.jsp"></jsp:include>
		</div>
		    ...
		    <div class="sctr-right-box" style="margin-top:30px;">
				<div class="srb-nav-box2">Download W&B Periodicals</div>
			</div>
		    ...
		    <div class="mt15">
			    ...
			    <a onclick="dowloadFile()" href="javascript:void(0);" class="scl-xz-btn fl ml10">Download</a>
			    <div class="cb"></div>
		    </div>
		    
		    
		     <div class="sctr-right-box" style="margin-top:10px;">
				<div class="srb-nav-box2">Typical cases of Watson & Band</div>
			</div>
			<div id="hcActive1">
				<jsp:include page="/WEB-INF/pages/front_en/cms/pub_index_inc2.jsp"></jsp:include>
			</div>
...
<script type="text/javascript">
		...
		var cmsChannels = $("#cmsChannels");
		 cmsChannels.change(function(){
		 	if(cmsChannels.val() !=""){
		 		$.post(base+"en/pub_ListPage_inc_en.htm",{"item.channelId":cmsChannels.val()},function(data){
					$("#cmsArticle").children().remove();
					$("#cmsArticle").html("<option value='-1' >-- Please select --</option>");
	...
	function dowloadFile(){
		...
		if(id == -1){
			$.dialog.tips("Please select file to download");
			return false;
		}
		if(cmsChannels == ''){
			$.dialog.tips("Please select type of periodical…");
			return false;
		}
		
		window.location.href = basePath+"dowloadFileEn.htm?selIds="+id;
	}
</script>
</html>
