	...
	<div class="act-index-middlebox">
		<div class="fl act-left-box">
			...
			<ul class="act-left-ul">
				<li class="cur">
					<a href="front/activity_en/activities_ListPage_en.htm" class="jzhd-ico">
						SEMINARS & EVENTS
					</a>
				</li>
				<!-- <li>
			...
			<div class="mt10">
					<a class="pw-wa" href="cms_en/to_common_problem_en.htm">Common problem</a>
					<i></i>
				</a>
				<!-- <a class="dy-wa" href="#">
					华诚通讯订阅 -->
		...
		<div class="fr actright-box">
			...
			<c:forEach items="${listActivity}" var="activity">
				<div class="mb15 clb">
					<div class="hd-imgbox fl">
						<a target="_blank" href="front/activity_en/activities_detail_en.htm?selIds=${activity.id }"><img src="${activity.photo }"></a>
					</div>
					<div class="fr hd-ccbox">
						<div class="hd-cc-tt"><a target="_blank" href="front/activity_en/activities_detail_en.htm?selIds=${activity.id }">${activity.titleEn}</a></div>
						<div class="addr-date mt5">
							<label>Date：</label><span>${activity.dateStrEn}</span>
							<label class="ml30">Location：</label><span>${activity.addressEn}</span>
						</div>
						<div class="scl-act-content mt5">
						<a target="_blank" class="news-remark-a" href="front/activity_en/activities_detail_en.htm?selIds=${activity.id }">${dv:e(activity.promEn,275)}</a>
						</div>
						<a href="javascript:void(0);" class="ljbm-btn yjfk" data="${activity.id}">Sign up now</a>
					</div>
				</div>	
				</c:forEach>
				<div class="cb"></div>
			...
			<div class="scl-hdyg-box">
				...
				<c:forEach items="${listActivityPrediction }" var ="listActivityPrediction">
					<li>
						<div class="sclhdyg-imgbox"><a target="_blank" href="front/activity_en/activities_detail_en.htm?selIds=${listActivityPrediction.id }"><img src="${listActivityPrediction.photo }"></a></div>
						<div class="sclhdyg-name">
							<a target="_blank" href="front/activity_en/activities_detail_en.htm?selIds=${listActivityPrediction.id }" title="${listActivityPrediction.titleEn}">${dv:e(listActivityPrediction.titleEn,55)}</a>
						</div>
						<div class="addr-date mt15">
							<label>Date：</label><span>${listActivityPrediction.dateStrEn}</span>
						</div>
						<%-- <div class="scl-act-content mt5">
	 		...
	 		<!-- 历届 活动 -->
 			<div id="pageinc">
				<jsp:include page="/WEB-INF/pages/front_en/activities/activities_index_inc.jsp"></jsp:include>
			</div>
	 		<!-- 历届 活动 -->
